...
# Unit tests for LemonWayClient::SddMandate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SddMandate' do
  before do
    # run before each test
    @instance = LemonWayClient::SddMandate.new
  end
  ...
  describe 'test an instance of SddMandate' do
    it 'should create an instance of SddMandate' do
      expect(@instance).to be_instance_of(LemonWayClient::SddMandate)
    end
  end
