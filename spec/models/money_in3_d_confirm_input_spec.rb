...
# Unit tests for LemonWayClient::MoneyIn3DConfirmInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyIn3DConfirmInput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyIn3DConfirmInput.new
  end
  ...
  describe 'test an instance of MoneyIn3DConfirmInput' do
    it 'should create an instance of MoneyIn3DConfirmInput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyIn3DConfirmInput)
    end
  end
