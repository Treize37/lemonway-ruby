...
# Unit tests for LemonWayClient::GetMoneyInTransDetailsInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMoneyInTransDetailsInput' do
  before do
    # run before each test
    @instance = LemonWayClient::GetMoneyInTransDetailsInput.new
  end
  ...
  describe 'test an instance of GetMoneyInTransDetailsInput' do
    it 'should create an instance of GetMoneyInTransDetailsInput' do
      expect(@instance).to be_instance_of(LemonWayClient::GetMoneyInTransDetailsInput)
    end
  end
  ...
  describe 'test attribute "transaction_comment"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "transaction_merchant_token"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
