...
# Unit tests for SwaggerClient::GetMoneyInTransDetailsInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMoneyInTransDetailsInput' do
  before do
    # run before each test
    @instance = SwaggerClient::GetMoneyInTransDetailsInput.new
  end
  ...
  describe 'test an instance of GetMoneyInTransDetailsInput' do
    it 'should create an instance of GetMoneyInTransDetailsInput' do
      expect(@instance).to be_instance_of(SwaggerClient::GetMoneyInTransDetailsInput)
    end
  end
