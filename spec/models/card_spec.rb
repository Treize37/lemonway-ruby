...
# Unit tests for LemonWayClient::Card
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Card' do
  before do
    # run before each test
    @instance = LemonWayClient::Card.new
  end
  ...
  describe 'test an instance of Card' do
    it 'should create an instance of Card' do
      expect(@instance).to be_instance_of(LemonWayClient::Card)
    end
  end
  ...
  describe 'test attribute "is3_ds"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "masked_number"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
