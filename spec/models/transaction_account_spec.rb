...
# Unit tests for SwaggerClient::TransactionAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionAccount' do
  before do
    # run before each test
    @instance = SwaggerClient::TransactionAccount.new
  end
  ...
  describe 'test an instance of TransactionAccount' do
    it 'should create an instance of TransactionAccount' do
      expect(@instance).to be_instance_of(SwaggerClient::TransactionAccount)
    end
  end
