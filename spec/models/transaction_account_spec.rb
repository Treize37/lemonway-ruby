...
# Unit tests for LemonWayClient::TransactionAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionAccount' do
  before do
    # run before each test
    @instance = LemonWayClient::TransactionAccount.new
  end
  ...
  describe 'test an instance of TransactionAccount' do
    it 'should create an instance of TransactionAccount' do
      expect(@instance).to be_instance_of(LemonWayClient::TransactionAccount)
    end
  end
  describe 'test attribute "transaction_in"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "transaction_out"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "transaction_p2_p"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
