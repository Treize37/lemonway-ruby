...
# Unit tests for LemonWayClient::MoneyOutOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyOutOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyOutOutput.new
  end
  ...
  describe 'test an instance of MoneyOutOutput' do
    it 'should create an instance of MoneyOutOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyOutOutput)
    end
  end
