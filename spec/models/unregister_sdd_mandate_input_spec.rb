...
# Unit tests for SwaggerClient::UnregisterSddMandateInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UnregisterSddMandateInput' do
  before do
    # run before each test
    @instance = SwaggerClient::UnregisterSddMandateInput.new
  end
  ...
  describe 'test an instance of UnregisterSddMandateInput' do
    it 'should create an instance of UnregisterSddMandateInput' do
      expect(@instance).to be_instance_of(SwaggerClient::UnregisterSddMandateInput)
    end
  end
