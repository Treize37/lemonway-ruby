...
# Unit tests for LemonWayClient::UnregisterSddMandateInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UnregisterSddMandateInput' do
  before do
    # run before each test
    @instance = LemonWayClient::UnregisterSddMandateInput.new
  end
  ...
  describe 'test an instance of UnregisterSddMandateInput' do
    it 'should create an instance of UnregisterSddMandateInput' do
      expect(@instance).to be_instance_of(LemonWayClient::UnregisterSddMandateInput)
    end
  end
