...
# Unit tests for LemonWayClient::GetCompletedPaymentFormOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCompletedPaymentFormOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::GetCompletedPaymentFormOutput.new
  end
  ...
  describe 'test an instance of GetCompletedPaymentFormOutput' do
    it 'should create an instance of GetCompletedPaymentFormOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::GetCompletedPaymentFormOutput)
    end
  end
