...
# Unit tests for SwaggerClient::MoneyInWebInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInWebInitInput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInWebInitInput.new
  end
  ...
  describe 'test an instance of MoneyInWebInitInput' do
    it 'should create an instance of MoneyInWebInitInput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInWebInitInput)
    end
  end
