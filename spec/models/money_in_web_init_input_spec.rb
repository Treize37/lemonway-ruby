...
# Unit tests for LemonWayClient::MoneyInWebInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInWebInitInput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInWebInitInput.new
  end
  ...
  describe 'test an instance of MoneyInWebInitInput' do
    it 'should create an instance of MoneyInWebInitInput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInWebInitInput)
    end
  end
  ...
  describe 'test attribute "register_card"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "capture_delayed_days"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "money_in_nature"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Integer', ["0", "1"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.money_in_nature = value }.not_to raise_error
      # end
    end
  end
