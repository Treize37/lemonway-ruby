...
# Unit tests for LemonWayClient::MoneyInChequeInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInChequeInitOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInChequeInitOutput.new
  end
  ...
  describe 'test an instance of MoneyInChequeInitOutput' do
    it 'should create an instance of MoneyInChequeInitOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInChequeInitOutput)
    end
  end
