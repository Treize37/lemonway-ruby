...
# Unit tests for SwaggerClient::MoneyInChequeInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInChequeInitOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInChequeInitOutput.new
  end
  ...
  describe 'test an instance of MoneyInChequeInitOutput' do
    it 'should create an instance of MoneyInChequeInitOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInChequeInitOutput)
    end
  end
