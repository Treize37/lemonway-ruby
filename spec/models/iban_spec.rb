...
# Unit tests for LemonWayClient::Iban
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Iban' do
  before do
    # run before each test
    @instance = LemonWayClient::Iban.new
  end
  ...
  describe 'test an instance of Iban' do
    it 'should create an instance of Iban' do
      expect(@instance).to be_instance_of(LemonWayClient::Iban)
    end
  end
