...
# Unit tests for LemonWayClient::MoneyInWithCardIdOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInWithCardIdOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInWithCardIdOutput.new
  end
  ...
  describe 'test an instance of MoneyInWithCardIdOutput' do
    it 'should create an instance of MoneyInWithCardIdOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInWithCardIdOutput)
    end
  end
