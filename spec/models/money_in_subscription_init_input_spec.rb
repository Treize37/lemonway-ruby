...
# Unit tests for LemonWayClient::MoneyInSubscriptionInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInSubscriptionInitInput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInSubscriptionInitInput.new
  end
  ...
  describe 'test an instance of MoneyInSubscriptionInitInput' do
    it 'should create an instance of MoneyInSubscriptionInitInput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInSubscriptionInitInput)
    end
  end
