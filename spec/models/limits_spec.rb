...
# Unit tests for LemonWayClient::Limits
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Limits' do
  before do
    # run before each test
    @instance = LemonWayClient::Limits.new
  end
  ...
  describe 'test an instance of Limits' do
    it 'should create an instance of Limits' do
      expect(@instance).to be_instance_of(LemonWayClient::Limits)
    end
  end
  describe 'test attribute "total_money_in_allowed"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "amount_money_in_allowed"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
