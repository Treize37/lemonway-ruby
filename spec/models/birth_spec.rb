...
# Unit tests for LemonWayClient::Birth
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Birth' do
  before do
    # run before each test
    @instance = LemonWayClient::Birth.new
  end
  ...
  describe 'test an instance of Birth' do
    it 'should create an instance of Birth' do
      expect(@instance).to be_instance_of(LemonWayClient::Birth)
    end
  end
