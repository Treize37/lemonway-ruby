...
# Unit tests for SwaggerClient::SendPaymentOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SendPaymentOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::SendPaymentOutput.new
  end
  ...
  describe 'test an instance of SendPaymentOutput' do
    it 'should create an instance of SendPaymentOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::SendPaymentOutput)
    end
  end
