...
# Unit tests for LemonWayClient::SendPaymentOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SendPaymentOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::SendPaymentOutput.new
  end
  ...
  describe 'test an instance of SendPaymentOutput' do
    it 'should create an instance of SendPaymentOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::SendPaymentOutput)
    end
  end
