...
# Unit tests for SwaggerClient::SendPaymentInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SendPaymentInput' do
  before do
    # run before each test
    @instance = SwaggerClient::SendPaymentInput.new
  end
  ...
  describe 'test an instance of SendPaymentInput' do
    it 'should create an instance of SendPaymentInput' do
      expect(@instance).to be_instance_of(SwaggerClient::SendPaymentInput)
    end
  end
