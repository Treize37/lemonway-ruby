...
# Unit tests for LemonWayClient::SendPaymentInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SendPaymentInput' do
  before do
    # run before each test
    @instance = LemonWayClient::SendPaymentInput.new
  end
  ...
  describe 'test an instance of SendPaymentInput' do
    it 'should create an instance of SendPaymentInput' do
      expect(@instance).to be_instance_of(LemonWayClient::SendPaymentInput)
    end
  end
  ...
  describe 'test attribute "origin_transaction_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
