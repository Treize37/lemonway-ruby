...
# Unit tests for SwaggerClient::UpdateLegalAccountDetailsOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateLegalAccountDetailsOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateLegalAccountDetailsOutput.new
  end
  ...
  describe 'test an instance of UpdateLegalAccountDetailsOutput' do
    it 'should create an instance of UpdateLegalAccountDetailsOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateLegalAccountDetailsOutput)
    end
  end
