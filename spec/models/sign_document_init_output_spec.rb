...
# Unit tests for SwaggerClient::SignDocumentInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SignDocumentInitOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::SignDocumentInitOutput.new
  end
  ...
  describe 'test an instance of SignDocumentInitOutput' do
    it 'should create an instance of SignDocumentInitOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::SignDocumentInitOutput)
    end
  end
