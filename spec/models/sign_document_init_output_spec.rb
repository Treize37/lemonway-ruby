...
# Unit tests for LemonWayClient::SignDocumentInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SignDocumentInitOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::SignDocumentInitOutput.new
  end
  ...
  describe 'test an instance of SignDocumentInitOutput' do
    it 'should create an instance of SignDocumentInitOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::SignDocumentInitOutput)
    end
  end
  describe 'test attribute "sign_document"' do
    it 'should work' do
