...
# Unit tests for LemonWayClient::TransactionsTransactionIn
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionsTransactionIn' do
  before do
    # run before each test
    @instance = LemonWayClient::TransactionsTransactionIn.new
  end
  ...
  describe 'test an instance of TransactionsTransactionIn' do
    it 'should create an instance of TransactionsTransactionIn' do
      expect(@instance).to be_instance_of(LemonWayClient::TransactionsTransactionIn)
    end
  end
