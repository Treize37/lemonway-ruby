...
# Unit tests for LemonWayClient::GetMoneyInIBANDetailsInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMoneyInIBANDetailsInput' do
  before do
    # run before each test
    @instance = LemonWayClient::GetMoneyInIBANDetailsInput.new
  end
  ...
  describe 'test an instance of GetMoneyInIBANDetailsInput' do
    it 'should create an instance of GetMoneyInIBANDetailsInput' do
      expect(@instance).to be_instance_of(LemonWayClient::GetMoneyInIBANDetailsInput)
    end
  end
