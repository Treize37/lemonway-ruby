...
# Unit tests for SwaggerClient::MoneyIn3DInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyIn3DInitOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyIn3DInitOutput.new
  end
  ...
  describe 'test an instance of MoneyIn3DInitOutput' do
    it 'should create an instance of MoneyIn3DInitOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyIn3DInitOutput)
    end
  end
