...
# Unit tests for SwaggerClient::MoneyInMultibancoInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInMultibancoInitOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInMultibancoInitOutput.new
  end
  ...
  describe 'test an instance of MoneyInMultibancoInitOutput' do
    it 'should create an instance of MoneyInMultibancoInitOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInMultibancoInitOutput)
    end
  end
