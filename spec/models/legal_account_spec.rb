...
# Unit tests for LemonWayClient::LegalAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LegalAccount' do
  before do
    # run before each test
    @instance = LemonWayClient::LegalAccount.new
  end
  ...
  describe 'test an instance of LegalAccount' do
    it 'should create an instance of LegalAccount' do
      expect(@instance).to be_instance_of(LemonWayClient::LegalAccount)
    end
  end
  ...
  describe 'test attribute "lemonway_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
