...
# Unit tests for LemonWayClient::RegisterSddMandateInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterSddMandateInput' do
  before do
    # run before each test
    @instance = LemonWayClient::RegisterSddMandateInput.new
  end
  ...
  describe 'test an instance of RegisterSddMandateInput' do
    it 'should create an instance of RegisterSddMandateInput' do
      expect(@instance).to be_instance_of(LemonWayClient::RegisterSddMandateInput)
    end
  end
  ...
  describe 'test attribute "is_b2_b"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "mandate_language"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "rum"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
