...
# Unit tests for SwaggerClient::RegisterSddMandateInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterSddMandateInput' do
  before do
    # run before each test
    @instance = SwaggerClient::RegisterSddMandateInput.new
  end
  ...
  describe 'test an instance of RegisterSddMandateInput' do
    it 'should create an instance of RegisterSddMandateInput' do
      expect(@instance).to be_instance_of(SwaggerClient::RegisterSddMandateInput)
    end
  end
