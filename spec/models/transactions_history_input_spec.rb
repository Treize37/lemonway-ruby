...
# Unit tests for LemonWayClient::TransactionsHistoryInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionsHistoryInput' do
  before do
    # run before each test
    @instance = LemonWayClient::TransactionsHistoryInput.new
  end
  ...
  describe 'test an instance of TransactionsHistoryInput' do
    it 'should create an instance of TransactionsHistoryInput' do
      expect(@instance).to be_instance_of(LemonWayClient::TransactionsHistoryInput)
    end
  end
