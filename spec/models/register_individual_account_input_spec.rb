...
# Unit tests for LemonWayClient::RegisterIndividualAccountInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterIndividualAccountInput' do
  before do
    # run before each test
    @instance = LemonWayClient::RegisterIndividualAccountInput.new
  end
  ...
  describe 'test an instance of RegisterIndividualAccountInput' do
    it 'should create an instance of RegisterIndividualAccountInput' do
      expect(@instance).to be_instance_of(LemonWayClient::RegisterIndividualAccountInput)
    end
  end
  ...
  describe 'test attribute "birth"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "payer_or_beneficiary"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "is_one_time_customer_account"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "is_technical_account"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
