...
# Unit tests for SwaggerClient::RegisterIndividualAccountInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterIndividualAccountInput' do
  before do
    # run before each test
    @instance = SwaggerClient::RegisterIndividualAccountInput.new
  end
  ...
  describe 'test an instance of RegisterIndividualAccountInput' do
    it 'should create an instance of RegisterIndividualAccountInput' do
      expect(@instance).to be_instance_of(SwaggerClient::RegisterIndividualAccountInput)
    end
  end
