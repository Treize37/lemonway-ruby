...
# Unit tests for LemonWayClient::MoneyIn3DAuthenticateOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyIn3DAuthenticateOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyIn3DAuthenticateOutput.new
  end
  ...
  describe 'test an instance of MoneyIn3DAuthenticateOutput' do
    it 'should create an instance of MoneyIn3DAuthenticateOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyIn3DAuthenticateOutput)
    end
  end
  describe 'test attribute "operation3_d_code"' do
    it 'should work' do
