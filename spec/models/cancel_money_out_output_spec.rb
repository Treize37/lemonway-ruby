...
# Unit tests for LemonWayClient::CancelMoneyOutOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CancelMoneyOutOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::CancelMoneyOutOutput.new
  end
  ...
  describe 'test an instance of CancelMoneyOutOutput' do
    it 'should create an instance of CancelMoneyOutOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::CancelMoneyOutOutput)
    end
  end
