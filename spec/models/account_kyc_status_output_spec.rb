...
# Unit tests for LemonWayClient::AccountKycStatusOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountKycStatusOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::AccountKycStatusOutput.new
  end
  ...
  describe 'test an instance of AccountKycStatusOutput' do
    it 'should create an instance of AccountKycStatusOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::AccountKycStatusOutput)
    end
  end
