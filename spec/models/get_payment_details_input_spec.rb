...
# Unit tests for SwaggerClient::GetPaymentDetailsInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetPaymentDetailsInput' do
  before do
    # run before each test
    @instance = SwaggerClient::GetPaymentDetailsInput.new
  end
  ...
  describe 'test an instance of GetPaymentDetailsInput' do
    it 'should create an instance of GetPaymentDetailsInput' do
      expect(@instance).to be_instance_of(SwaggerClient::GetPaymentDetailsInput)
    end
  end
