...
# Unit tests for SwaggerClient::CancelMoneyInOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CancelMoneyInOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::CancelMoneyInOutput.new
  end
  ...
  describe 'test an instance of CancelMoneyInOutput' do
    it 'should create an instance of CancelMoneyInOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::CancelMoneyInOutput)
    end
  end
