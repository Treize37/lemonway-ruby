...
# Unit tests for LemonWayClient::CancelMoneyInOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CancelMoneyInOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::CancelMoneyInOutput.new
  end
  ...
  describe 'test an instance of CancelMoneyInOutput' do
    it 'should create an instance of CancelMoneyInOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::CancelMoneyInOutput)
    end
  end
