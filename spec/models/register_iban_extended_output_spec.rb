...
# Unit tests for SwaggerClient::RegisterIBANExtendedOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterIBANExtendedOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::RegisterIBANExtendedOutput.new
  end
  ...
  describe 'test an instance of RegisterIBANExtendedOutput' do
    it 'should create an instance of RegisterIBANExtendedOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::RegisterIBANExtendedOutput)
    end
  end
