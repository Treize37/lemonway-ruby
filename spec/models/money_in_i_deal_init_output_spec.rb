...
# Unit tests for LemonWayClient::MoneyInIDealInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInIDealInitOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInIDealInitOutput.new
  end
  ...
  describe 'test an instance of MoneyInIDealInitOutput' do
    it 'should create an instance of MoneyInIDealInitOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInIDealInitOutput)
    end
  end
