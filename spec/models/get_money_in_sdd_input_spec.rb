...
# Unit tests for LemonWayClient::GetMoneyInSddInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMoneyInSddInput' do
  before do
    # run before each test
    @instance = LemonWayClient::GetMoneyInSddInput.new
  end
  ...
  describe 'test an instance of GetMoneyInSddInput' do
    it 'should create an instance of GetMoneyInSddInput' do
      expect(@instance).to be_instance_of(LemonWayClient::GetMoneyInSddInput)
    end
  end
