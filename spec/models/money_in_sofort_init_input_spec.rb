...
# Unit tests for LemonWayClient::MoneyInSofortInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInSofortInitInput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInSofortInitInput.new
  end
  ...
  describe 'test an instance of MoneyInSofortInitInput' do
    it 'should create an instance of MoneyInSofortInitInput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInSofortInitInput)
    end
  end
