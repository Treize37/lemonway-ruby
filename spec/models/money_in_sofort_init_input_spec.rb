...
# Unit tests for SwaggerClient::MoneyInSofortInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInSofortInitInput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInSofortInitInput.new
  end
  ...
  describe 'test an instance of MoneyInSofortInitInput' do
    it 'should create an instance of MoneyInSofortInitInput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInSofortInitInput)
    end
  end
