...
# Unit tests for SwaggerClient::MoneyInMobilePayInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInMobilePayInitInput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInMobilePayInitInput.new
  end
  ...
  describe 'test an instance of MoneyInMobilePayInitInput' do
    it 'should create an instance of MoneyInMobilePayInitInput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInMobilePayInitInput)
    end
  end
