...
# Unit tests for SwaggerClient::AccountDocumentsOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountDocumentsOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::AccountDocumentsOutput.new
  end
  ...
  describe 'test an instance of AccountDocumentsOutput' do
    it 'should create an instance of AccountDocumentsOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::AccountDocumentsOutput)
    end
  end
