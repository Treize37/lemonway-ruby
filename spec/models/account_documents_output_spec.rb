...
# Unit tests for LemonWayClient::AccountDocumentsOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountDocumentsOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::AccountDocumentsOutput.new
  end
  ...
  describe 'test an instance of AccountDocumentsOutput' do
    it 'should create an instance of AccountDocumentsOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::AccountDocumentsOutput)
    end
  end
