...
# Unit tests for LemonWayClient::MoneyInIDealInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInIDealInitInput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInIDealInitInput.new
  end
  ...
  describe 'test an instance of MoneyInIDealInitInput' do
    it 'should create an instance of MoneyInIDealInitInput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInIDealInitInput)
    end
  end
