...
# Unit tests for LemonWayClient::UpdateAccountStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateAccountStatus' do
  before do
    # run before each test
    @instance = LemonWayClient::UpdateAccountStatus.new
  end
  ...
  describe 'test an instance of UpdateAccountStatus' do
    it 'should create an instance of UpdateAccountStatus' do
      expect(@instance).to be_instance_of(LemonWayClient::UpdateAccountStatus)
    end
  end
