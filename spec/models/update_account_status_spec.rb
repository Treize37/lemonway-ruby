...
# Unit tests for SwaggerClient::UpdateAccountStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateAccountStatus' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateAccountStatus.new
  end
  ...
  describe 'test an instance of UpdateAccountStatus' do
    it 'should create an instance of UpdateAccountStatus' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateAccountStatus)
    end
  end
