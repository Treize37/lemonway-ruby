...
# Unit tests for LemonWayClient::GetPaymentDetailsOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetPaymentDetailsOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::GetPaymentDetailsOutput.new
  end
  ...
  describe 'test an instance of GetPaymentDetailsOutput' do
    it 'should create an instance of GetPaymentDetailsOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::GetPaymentDetailsOutput)
    end
  end
