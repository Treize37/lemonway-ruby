...
# Unit tests for LemonWayClient::WalletDetailsInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WalletDetailsInput' do
  before do
    # run before each test
    @instance = LemonWayClient::WalletDetailsInput.new
  end
  ...
  describe 'test an instance of WalletDetailsInput' do
    it 'should create an instance of WalletDetailsInput' do
      expect(@instance).to be_instance_of(LemonWayClient::WalletDetailsInput)
    end
  end
  describe 'test attribute "accountid"' do
    it 'should work' do
