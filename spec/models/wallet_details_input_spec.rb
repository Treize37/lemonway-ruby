...
# Unit tests for SwaggerClient::WalletDetailsInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WalletDetailsInput' do
  before do
    # run before each test
    @instance = SwaggerClient::WalletDetailsInput.new
  end
  ...
  describe 'test an instance of WalletDetailsInput' do
    it 'should create an instance of WalletDetailsInput' do
      expect(@instance).to be_instance_of(SwaggerClient::WalletDetailsInput)
    end
  end
