...
# Unit tests for SwaggerClient::RegisterLegalAccountOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterLegalAccountOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::RegisterLegalAccountOutput.new
  end
  ...
  describe 'test an instance of RegisterLegalAccountOutput' do
    it 'should create an instance of RegisterLegalAccountOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::RegisterLegalAccountOutput)
    end
  end
