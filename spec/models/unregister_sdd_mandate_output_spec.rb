...
# Unit tests for SwaggerClient::UnregisterSddMandateOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UnregisterSddMandateOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::UnregisterSddMandateOutput.new
  end
  ...
  describe 'test an instance of UnregisterSddMandateOutput' do
    it 'should create an instance of UnregisterSddMandateOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::UnregisterSddMandateOutput)
    end
  end
