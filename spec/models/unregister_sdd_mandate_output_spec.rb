...
# Unit tests for LemonWayClient::UnregisterSddMandateOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UnregisterSddMandateOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::UnregisterSddMandateOutput.new
  end
  ...
  describe 'test an instance of UnregisterSddMandateOutput' do
    it 'should create an instance of UnregisterSddMandateOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::UnregisterSddMandateOutput)
    end
  end
  describe 'test attribute "sdd_mandate"' do
    it 'should work' do
