...
# Unit tests for LemonWayClient::MoneyInChequeInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInChequeInitInput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInChequeInitInput.new
  end
  ...
  describe 'test an instance of MoneyInChequeInitInput' do
    it 'should create an instance of MoneyInChequeInitInput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInChequeInitInput)
    end
  end
  ...
  describe 'test attribute "cheque_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Integer', ["15", "23"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.cheque_type = value }.not_to raise_error
      # end
    end
  end
