...
# Unit tests for SwaggerClient::MoneyInChequeInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInChequeInitInput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInChequeInitInput.new
  end
  ...
  describe 'test an instance of MoneyInChequeInitInput' do
    it 'should create an instance of MoneyInChequeInitInput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInChequeInitInput)
    end
  end
