...
# Unit tests for SwaggerClient::MoneyIn3DInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyIn3DInitInput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyIn3DInitInput.new
  end
  ...
  describe 'test an instance of MoneyIn3DInitInput' do
    it 'should create an instance of MoneyIn3DInitInput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyIn3DInitInput)
    end
  end
