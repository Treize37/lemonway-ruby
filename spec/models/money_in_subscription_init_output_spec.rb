...
# Unit tests for LemonWayClient::MoneyInSubscriptionInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInSubscriptionInitOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInSubscriptionInitOutput.new
  end
  ...
  describe 'test an instance of MoneyInSubscriptionInitOutput' do
    it 'should create an instance of MoneyInSubscriptionInitOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInSubscriptionInitOutput)
    end
  end
