...
# Unit tests for SwaggerClient::UnregisterCardInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UnregisterCardInput' do
  before do
    # run before each test
    @instance = SwaggerClient::UnregisterCardInput.new
  end
  ...
  describe 'test an instance of UnregisterCardInput' do
    it 'should create an instance of UnregisterCardInput' do
      expect(@instance).to be_instance_of(SwaggerClient::UnregisterCardInput)
    end
  end
