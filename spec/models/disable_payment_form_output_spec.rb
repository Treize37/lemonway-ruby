...
# Unit tests for LemonWayClient::DisablePaymentFormOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DisablePaymentFormOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::DisablePaymentFormOutput.new
  end
  ...
  describe 'test an instance of DisablePaymentFormOutput' do
    it 'should create an instance of DisablePaymentFormOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::DisablePaymentFormOutput)
    end
  end
