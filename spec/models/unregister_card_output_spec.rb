...
# Unit tests for LemonWayClient::UnregisterCardOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UnregisterCardOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::UnregisterCardOutput.new
  end
  ...
  describe 'test an instance of UnregisterCardOutput' do
    it 'should create an instance of UnregisterCardOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::UnregisterCardOutput)
    end
  end
