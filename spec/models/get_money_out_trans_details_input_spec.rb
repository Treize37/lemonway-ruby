...
# Unit tests for SwaggerClient::GetMoneyOutTransDetailsInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMoneyOutTransDetailsInput' do
  before do
    # run before each test
    @instance = SwaggerClient::GetMoneyOutTransDetailsInput.new
  end
  ...
  describe 'test an instance of GetMoneyOutTransDetailsInput' do
    it 'should create an instance of GetMoneyOutTransDetailsInput' do
      expect(@instance).to be_instance_of(SwaggerClient::GetMoneyOutTransDetailsInput)
    end
  end
