...
# Unit tests for LemonWayClient::GetMoneyOutTransDetailsInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMoneyOutTransDetailsInput' do
  before do
    # run before each test
    @instance = LemonWayClient::GetMoneyOutTransDetailsInput.new
  end
  ...
  describe 'test an instance of GetMoneyOutTransDetailsInput' do
    it 'should create an instance of GetMoneyOutTransDetailsInput' do
      expect(@instance).to be_instance_of(LemonWayClient::GetMoneyOutTransDetailsInput)
    end
  end
  describe 'test attribute "transactionid"' do
    it 'should work' do
