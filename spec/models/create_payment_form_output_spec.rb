...
# Unit tests for LemonWayClient::CreatePaymentFormOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreatePaymentFormOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::CreatePaymentFormOutput.new
  end
  ...
  describe 'test an instance of CreatePaymentFormOutput' do
    it 'should create an instance of CreatePaymentFormOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::CreatePaymentFormOutput)
    end
  end
