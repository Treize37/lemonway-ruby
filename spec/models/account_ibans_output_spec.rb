...
# Unit tests for LemonWayClient::AccountIbansOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountIbansOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::AccountIbansOutput.new
  end
  ...
  describe 'test an instance of AccountIbansOutput' do
    it 'should create an instance of AccountIbansOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::AccountIbansOutput)
    end
  end
