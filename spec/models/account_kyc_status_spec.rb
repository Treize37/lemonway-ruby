...
# Unit tests for SwaggerClient::AccountKycStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountKycStatus' do
  before do
    # run before each test
    @instance = SwaggerClient::AccountKycStatus.new
  end
  ...
  describe 'test an instance of AccountKycStatus' do
    it 'should create an instance of AccountKycStatus' do
      expect(@instance).to be_instance_of(SwaggerClient::AccountKycStatus)
    end
  end
