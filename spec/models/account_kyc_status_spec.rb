...
# Unit tests for LemonWayClient::AccountKycStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountKycStatus' do
  before do
    # run before each test
    @instance = LemonWayClient::AccountKycStatus.new
  end
  ...
  describe 'test an instance of AccountKycStatus' do
    it 'should create an instance of AccountKycStatus' do
      expect(@instance).to be_instance_of(LemonWayClient::AccountKycStatus)
    end
  end
  ...
  describe 'test attribute "ibans"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "sdd_mandates"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
