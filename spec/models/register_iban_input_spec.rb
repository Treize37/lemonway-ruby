...
# Unit tests for SwaggerClient::RegisterIBANInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterIBANInput' do
  before do
    # run before each test
    @instance = SwaggerClient::RegisterIBANInput.new
  end
  ...
  describe 'test an instance of RegisterIBANInput' do
    it 'should create an instance of RegisterIBANInput' do
      expect(@instance).to be_instance_of(SwaggerClient::RegisterIBANInput)
    end
  end
