...
# Unit tests for LemonWayClient::RegisterIBANInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterIBANInput' do
  before do
    # run before each test
    @instance = LemonWayClient::RegisterIBANInput.new
  end
  ...
  describe 'test an instance of RegisterIBANInput' do
    it 'should create an instance of RegisterIBANInput' do
      expect(@instance).to be_instance_of(LemonWayClient::RegisterIBANInput)
    end
  end
  ...
  describe 'test attribute "domiciliation1"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "domiciliation2"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
