...
# Unit tests for LemonWayClient::AccountBlockedInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountBlockedInput' do
  before do
    # run before each test
    @instance = LemonWayClient::AccountBlockedInput.new
  end
  ...
  describe 'test an instance of AccountBlockedInput' do
    it 'should create an instance of AccountBlockedInput' do
      expect(@instance).to be_instance_of(LemonWayClient::AccountBlockedInput)
    end
  end
