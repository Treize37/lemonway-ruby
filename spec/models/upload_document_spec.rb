...
# Unit tests for LemonWayClient::UploadDocument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UploadDocument' do
  before do
    # run before each test
    @instance = LemonWayClient::UploadDocument.new
  end
  ...
  describe 'test an instance of UploadDocument' do
    it 'should create an instance of UploadDocument' do
      expect(@instance).to be_instance_of(LemonWayClient::UploadDocument)
    end
  end
