...
# Unit tests for SwaggerClient::RegisterCardInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterCardInput' do
  before do
    # run before each test
    @instance = SwaggerClient::RegisterCardInput.new
  end
  ...
  describe 'test an instance of RegisterCardInput' do
    it 'should create an instance of RegisterCardInput' do
      expect(@instance).to be_instance_of(SwaggerClient::RegisterCardInput)
    end
  end
