...
# Unit tests for LemonWayClient::RegisterCardInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterCardInput' do
  before do
    # run before each test
    @instance = LemonWayClient::RegisterCardInput.new
  end
  ...
  describe 'test an instance of RegisterCardInput' do
    it 'should create an instance of RegisterCardInput' do
      expect(@instance).to be_instance_of(LemonWayClient::RegisterCardInput)
    end
  end
  ...
  describe 'test attribute "special_configuration"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
