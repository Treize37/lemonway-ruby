...
# Unit tests for LemonWayClient::RegisterLegalAccountInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterLegalAccountInput' do
  before do
    # run before each test
    @instance = LemonWayClient::RegisterLegalAccountInput.new
  end
  ...
  describe 'test an instance of RegisterLegalAccountInput' do
    it 'should create an instance of RegisterLegalAccountInput' do
      expect(@instance).to be_instance_of(LemonWayClient::RegisterLegalAccountInput)
    end
  end
