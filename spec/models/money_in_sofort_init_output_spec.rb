...
# Unit tests for SwaggerClient::MoneyInSofortInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInSofortInitOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInSofortInitOutput.new
  end
  ...
  describe 'test an instance of MoneyInSofortInitOutput' do
    it 'should create an instance of MoneyInSofortInitOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInSofortInitOutput)
    end
  end
