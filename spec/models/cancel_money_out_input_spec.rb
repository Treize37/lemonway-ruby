...
# Unit tests for SwaggerClient::CancelMoneyOutInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CancelMoneyOutInput' do
  before do
    # run before each test
    @instance = SwaggerClient::CancelMoneyOutInput.new
  end
  ...
  describe 'test an instance of CancelMoneyOutInput' do
    it 'should create an instance of CancelMoneyOutInput' do
      expect(@instance).to be_instance_of(SwaggerClient::CancelMoneyOutInput)
    end
  end
