...
# Unit tests for LemonWayClient::CancelMoneyOutInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CancelMoneyOutInput' do
  before do
    # run before each test
    @instance = LemonWayClient::CancelMoneyOutInput.new
  end
  ...
  describe 'test an instance of CancelMoneyOutInput' do
    it 'should create an instance of CancelMoneyOutInput' do
      expect(@instance).to be_instance_of(LemonWayClient::CancelMoneyOutInput)
    end
  end
