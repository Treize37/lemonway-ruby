...
# Unit tests for SwaggerClient::GetMoneyInChequeDetailsOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMoneyInChequeDetailsOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::GetMoneyInChequeDetailsOutput.new
  end
  ...
  describe 'test an instance of GetMoneyInChequeDetailsOutput' do
    it 'should create an instance of GetMoneyInChequeDetailsOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::GetMoneyInChequeDetailsOutput)
    end
  end
