...
# Unit tests for LemonWayClient::TransactionsTransactionP2P
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionsTransactionP2P' do
  before do
    # run before each test
    @instance = LemonWayClient::TransactionsTransactionP2P.new
  end
  ...
  describe 'test an instance of TransactionsTransactionP2P' do
    it 'should create an instance of TransactionsTransactionP2P' do
      expect(@instance).to be_instance_of(LemonWayClient::TransactionsTransactionP2P)
    end
  end
