...
# Unit tests for SwaggerClient::TransactionsTransactionP2P
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionsTransactionP2P' do
  before do
    # run before each test
    @instance = SwaggerClient::TransactionsTransactionP2P.new
  end
  ...
  describe 'test an instance of TransactionsTransactionP2P' do
    it 'should create an instance of TransactionsTransactionP2P' do
      expect(@instance).to be_instance_of(SwaggerClient::TransactionsTransactionP2P)
    end
  end
