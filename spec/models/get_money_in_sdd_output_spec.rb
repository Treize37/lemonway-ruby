...
# Unit tests for LemonWayClient::GetMoneyInSddOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMoneyInSddOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::GetMoneyInSddOutput.new
  end
  ...
  describe 'test an instance of GetMoneyInSddOutput' do
    it 'should create an instance of GetMoneyInSddOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::GetMoneyInSddOutput)
    end
  end
