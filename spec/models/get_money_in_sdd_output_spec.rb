...
# Unit tests for SwaggerClient::GetMoneyInSddOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMoneyInSddOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::GetMoneyInSddOutput.new
  end
  ...
  describe 'test an instance of GetMoneyInSddOutput' do
    it 'should create an instance of GetMoneyInSddOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::GetMoneyInSddOutput)
    end
  end
