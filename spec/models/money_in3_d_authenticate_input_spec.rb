...
# Unit tests for LemonWayClient::MoneyIn3DAuthenticateInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyIn3DAuthenticateInput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyIn3DAuthenticateInput.new
  end
  ...
  describe 'test an instance of MoneyIn3DAuthenticateInput' do
    it 'should create an instance of MoneyIn3DAuthenticateInput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyIn3DAuthenticateInput)
    end
  end
