...
# Unit tests for SwaggerClient::GetChargebacksOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetChargebacksOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::GetChargebacksOutput.new
  end
  ...
  describe 'test an instance of GetChargebacksOutput' do
    it 'should create an instance of GetChargebacksOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::GetChargebacksOutput)
    end
  end
