...
# Unit tests for SwaggerClient::MoneyInPayTrailInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInPayTrailInitOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInPayTrailInitOutput.new
  end
  ...
  describe 'test an instance of MoneyInPayTrailInitOutput' do
    it 'should create an instance of MoneyInPayTrailInitOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInPayTrailInitOutput)
    end
  end
