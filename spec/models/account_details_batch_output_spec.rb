...
# Unit tests for SwaggerClient::AccountDetailsBatchOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountDetailsBatchOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::AccountDetailsBatchOutput.new
  end
  ...
  describe 'test an instance of AccountDetailsBatchOutput' do
    it 'should create an instance of AccountDetailsBatchOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::AccountDetailsBatchOutput)
    end
  end
