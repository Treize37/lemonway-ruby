...
# Unit tests for LemonWayClient::AccountBlockedOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountBlockedOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::AccountBlockedOutput.new
  end
  ...
  describe 'test an instance of AccountBlockedOutput' do
    it 'should create an instance of AccountBlockedOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::AccountBlockedOutput)
    end
  end
