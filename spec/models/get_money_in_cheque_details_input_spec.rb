...
# Unit tests for LemonWayClient::GetMoneyInChequeDetailsInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMoneyInChequeDetailsInput' do
  before do
    # run before each test
    @instance = LemonWayClient::GetMoneyInChequeDetailsInput.new
  end
  ...
  describe 'test an instance of GetMoneyInChequeDetailsInput' do
    it 'should create an instance of GetMoneyInChequeDetailsInput' do
      expect(@instance).to be_instance_of(LemonWayClient::GetMoneyInChequeDetailsInput)
    end
  end
