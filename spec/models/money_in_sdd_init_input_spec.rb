...
# Unit tests for SwaggerClient::MoneyInSddInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInSddInitInput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInSddInitInput.new
  end
  ...
  describe 'test an instance of MoneyInSddInitInput' do
    it 'should create an instance of MoneyInSddInitInput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInSddInitInput)
    end
  end
