...
# Unit tests for LemonWayClient::KycStatusOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KycStatusOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::KycStatusOutput.new
  end
  ...
  describe 'test an instance of KycStatusOutput' do
    it 'should create an instance of KycStatusOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::KycStatusOutput)
    end
  end
