...
# Unit tests for SwaggerClient::MoneyInMbwayInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInMbwayInitOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInMbwayInitOutput.new
  end
  ...
  describe 'test an instance of MoneyInMbwayInitOutput' do
    it 'should create an instance of MoneyInMbwayInitOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInMbwayInitOutput)
    end
  end
