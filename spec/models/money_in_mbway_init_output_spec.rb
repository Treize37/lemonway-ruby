...
# Unit tests for LemonWayClient::MoneyInMbwayInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInMbwayInitOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInMbwayInitOutput.new
  end
  ...
  describe 'test an instance of MoneyInMbwayInitOutput' do
    it 'should create an instance of MoneyInMbwayInitOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInMbwayInitOutput)
    end
  end
