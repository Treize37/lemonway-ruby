...
# Unit tests for LemonWayClient::GetMoneyInTransDetailsOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMoneyInTransDetailsOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::GetMoneyInTransDetailsOutput.new
  end
  ...
  describe 'test an instance of GetMoneyInTransDetailsOutput' do
    it 'should create an instance of GetMoneyInTransDetailsOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::GetMoneyInTransDetailsOutput)
    end
  end
