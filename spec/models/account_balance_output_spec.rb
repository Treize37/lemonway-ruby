...
# Unit tests for SwaggerClient::AccountBalanceOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountBalanceOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::AccountBalanceOutput.new
  end
  ...
  describe 'test an instance of AccountBalanceOutput' do
    it 'should create an instance of AccountBalanceOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::AccountBalanceOutput)
    end
  end
