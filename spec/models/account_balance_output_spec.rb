...
# Unit tests for LemonWayClient::AccountBalanceOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountBalanceOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::AccountBalanceOutput.new
  end
  ...
  describe 'test an instance of AccountBalanceOutput' do
    it 'should create an instance of AccountBalanceOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::AccountBalanceOutput)
    end
  end
