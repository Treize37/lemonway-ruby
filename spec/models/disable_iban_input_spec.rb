...
# Unit tests for LemonWayClient::DisableIBANInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DisableIBANInput' do
  before do
    # run before each test
    @instance = LemonWayClient::DisableIBANInput.new
  end
  ...
  describe 'test an instance of DisableIBANInput' do
    it 'should create an instance of DisableIBANInput' do
      expect(@instance).to be_instance_of(LemonWayClient::DisableIBANInput)
    end
  end
