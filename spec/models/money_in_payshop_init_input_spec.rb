...
# Unit tests for SwaggerClient::MoneyInPayshopInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInPayshopInitInput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInPayshopInitInput.new
  end
  ...
  describe 'test an instance of MoneyInPayshopInitInput' do
    it 'should create an instance of MoneyInPayshopInitInput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInPayshopInitInput)
    end
  end
