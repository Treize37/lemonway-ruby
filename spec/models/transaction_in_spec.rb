...
# Unit tests for LemonWayClient::TransactionIn
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionIn' do
  before do
    # run before each test
    @instance = LemonWayClient::TransactionIn.new
  end
  ...
  describe 'test an instance of TransactionIn' do
    it 'should create an instance of TransactionIn' do
      expect(@instance).to be_instance_of(LemonWayClient::TransactionIn)
    end
  end
  describe 'test attribute "receiver_account_id"' do
    it 'should work' do
  ...
  describe 'test attribute "scheduled_number"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "masked_label"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "bank_status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "lemon_way_commission"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
