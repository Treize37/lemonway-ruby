...
# Unit tests for LemonWayClient::AccountCardsOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountCardsOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::AccountCardsOutput.new
  end
  ...
  describe 'test an instance of AccountCardsOutput' do
    it 'should create an instance of AccountCardsOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::AccountCardsOutput)
    end
  end
