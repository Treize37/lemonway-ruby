...
# Unit tests for SwaggerClient::AccountCardsOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountCardsOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::AccountCardsOutput.new
  end
  ...
  describe 'test an instance of AccountCardsOutput' do
    it 'should create an instance of AccountCardsOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::AccountCardsOutput)
    end
  end
