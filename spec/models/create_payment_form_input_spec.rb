...
# Unit tests for SwaggerClient::CreatePaymentFormInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreatePaymentFormInput' do
  before do
    # run before each test
    @instance = SwaggerClient::CreatePaymentFormInput.new
  end
  ...
  describe 'test an instance of CreatePaymentFormInput' do
    it 'should create an instance of CreatePaymentFormInput' do
      expect(@instance).to be_instance_of(SwaggerClient::CreatePaymentFormInput)
    end
  end
