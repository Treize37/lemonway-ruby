...
# Unit tests for LemonWayClient::CreatePaymentFormInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreatePaymentFormInput' do
  before do
    # run before each test
    @instance = LemonWayClient::CreatePaymentFormInput.new
  end
  ...
  describe 'test an instance of CreatePaymentFormInput' do
    it 'should create an instance of CreatePaymentFormInput' do
      expect(@instance).to be_instance_of(LemonWayClient::CreatePaymentFormInput)
    end
  end
  ...
  describe 'test attribute "wallet_payer"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "wallet_receiver"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
