...
# Unit tests for SwaggerClient::MoneyInMultibancoInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInMultibancoInitInput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInMultibancoInitInput.new
  end
  ...
  describe 'test an instance of MoneyInMultibancoInitInput' do
    it 'should create an instance of MoneyInMultibancoInitInput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInMultibancoInitInput)
    end
  end
