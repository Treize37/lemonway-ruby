...
# Unit tests for LemonWayClient::CardInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CardInfo' do
  before do
    # run before each test
    @instance = LemonWayClient::CardInfo.new
  end
  ...
  describe 'test an instance of CardInfo' do
    it 'should create an instance of CardInfo' do
      expect(@instance).to be_instance_of(LemonWayClient::CardInfo)
    end
  end
  ...
  describe 'test attribute "card_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "card_date"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
