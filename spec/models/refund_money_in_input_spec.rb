...
# Unit tests for SwaggerClient::RefundMoneyInInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RefundMoneyInInput' do
  before do
    # run before each test
    @instance = SwaggerClient::RefundMoneyInInput.new
  end
  ...
  describe 'test an instance of RefundMoneyInInput' do
    it 'should create an instance of RefundMoneyInInput' do
      expect(@instance).to be_instance_of(SwaggerClient::RefundMoneyInInput)
    end
  end
