...
# Unit tests for LemonWayClient::RefundMoneyInInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RefundMoneyInInput' do
  before do
    # run before each test
    @instance = LemonWayClient::RefundMoneyInInput.new
  end
  ...
  describe 'test an instance of RefundMoneyInInput' do
    it 'should create an instance of RefundMoneyInInput' do
      expect(@instance).to be_instance_of(LemonWayClient::RefundMoneyInInput)
    end
  end
  describe 'test attribute "amount_to_refund"' do
    it 'should work' do
