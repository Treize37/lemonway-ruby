...
# Unit tests for LemonWayClient::EuPagoInit
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EuPagoInit' do
  before do
    # run before each test
    @instance = LemonWayClient::EuPagoInit.new
  end
  ...
  describe 'test an instance of EuPagoInit' do
    it 'should create an instance of EuPagoInit' do
      expect(@instance).to be_instance_of(LemonWayClient::EuPagoInit)
    end
  end
