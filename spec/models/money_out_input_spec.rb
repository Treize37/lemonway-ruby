...
# Unit tests for LemonWayClient::MoneyOutInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyOutInput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyOutInput.new
  end
  ...
  describe 'test an instance of MoneyOutInput' do
    it 'should create an instance of MoneyOutInput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyOutInput)
    end
  end
