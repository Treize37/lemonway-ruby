...
# Unit tests for SwaggerClient::UpdateIndividualAccountDetailsInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateIndividualAccountDetailsInput' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateIndividualAccountDetailsInput.new
  end
  ...
  describe 'test an instance of UpdateIndividualAccountDetailsInput' do
    it 'should create an instance of UpdateIndividualAccountDetailsInput' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateIndividualAccountDetailsInput)
    end
  end
