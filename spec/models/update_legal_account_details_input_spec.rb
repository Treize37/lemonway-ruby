...
# Unit tests for LemonWayClient::UpdateLegalAccountDetailsInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateLegalAccountDetailsInput' do
  before do
    # run before each test
    @instance = LemonWayClient::UpdateLegalAccountDetailsInput.new
  end
  ...
  describe 'test an instance of UpdateLegalAccountDetailsInput' do
    it 'should create an instance of UpdateLegalAccountDetailsInput' do
      expect(@instance).to be_instance_of(LemonWayClient::UpdateLegalAccountDetailsInput)
    end
  end
