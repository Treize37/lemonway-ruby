...
# Unit tests for LemonWayClient::TransactionOut
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionOut' do
  before do
    # run before each test
    @instance = LemonWayClient::TransactionOut.new
  end
  ...
  describe 'test an instance of TransactionOut' do
    it 'should create an instance of TransactionOut' do
      expect(@instance).to be_instance_of(LemonWayClient::TransactionOut)
    end
  end
