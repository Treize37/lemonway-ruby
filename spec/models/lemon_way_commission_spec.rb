...
# Unit tests for LemonWayClient::LemonWayCommission
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LemonWayCommission' do
  before do
    # run before each test
    @instance = LemonWayClient::LemonWayCommission.new
  end
  ...
  describe 'test an instance of LemonWayCommission' do
    it 'should create an instance of LemonWayCommission' do
      expect(@instance).to be_instance_of(LemonWayClient::LemonWayCommission)
    end
  end
  describe 'test attribute "idp2p"' do
    it 'should work' do
