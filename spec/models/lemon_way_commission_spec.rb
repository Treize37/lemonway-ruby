...
# Unit tests for SwaggerClient::LemonWayCommission
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LemonWayCommission' do
  before do
    # run before each test
    @instance = SwaggerClient::LemonWayCommission.new
  end
  ...
  describe 'test an instance of LemonWayCommission' do
    it 'should create an instance of LemonWayCommission' do
      expect(@instance).to be_instance_of(SwaggerClient::LemonWayCommission)
    end
  end
