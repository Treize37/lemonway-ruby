...
# Unit tests for LemonWayClient::RegisterIBANExtendedInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterIBANExtendedInput' do
  before do
    # run before each test
    @instance = LemonWayClient::RegisterIBANExtendedInput.new
  end
  ...
  describe 'test an instance of RegisterIBANExtendedInput' do
    it 'should create an instance of RegisterIBANExtendedInput' do
      expect(@instance).to be_instance_of(LemonWayClient::RegisterIBANExtendedInput)
    end
  end
  ...
  describe 'test attribute "holder_country"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "intermediary_bic_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "intermediary_bank_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "intermediary_bank_country"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
