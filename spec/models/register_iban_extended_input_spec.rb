...
# Unit tests for SwaggerClient::RegisterIBANExtendedInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterIBANExtendedInput' do
  before do
    # run before each test
    @instance = SwaggerClient::RegisterIBANExtendedInput.new
  end
  ...
  describe 'test an instance of RegisterIBANExtendedInput' do
    it 'should create an instance of RegisterIBANExtendedInput' do
      expect(@instance).to be_instance_of(SwaggerClient::RegisterIBANExtendedInput)
    end
  end
