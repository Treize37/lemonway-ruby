...
# Unit tests for LemonWayClient::MoneyInMobilePayInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInMobilePayInitOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInMobilePayInitOutput.new
  end
  ...
  describe 'test an instance of MoneyInMobilePayInitOutput' do
    it 'should create an instance of MoneyInMobilePayInitOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInMobilePayInitOutput)
    end
  end
