...
# Unit tests for SwaggerClient::MoneyInMobilePayInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInMobilePayInitOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInMobilePayInitOutput.new
  end
  ...
  describe 'test an instance of MoneyInMobilePayInitOutput' do
    it 'should create an instance of MoneyInMobilePayInitOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInMobilePayInitOutput)
    end
  end
