...
# Unit tests for SwaggerClient::MoneyInValidateInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInValidateInput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInValidateInput.new
  end
  ...
  describe 'test an instance of MoneyInValidateInput' do
    it 'should create an instance of MoneyInValidateInput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInValidateInput)
    end
  end
