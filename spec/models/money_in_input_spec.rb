...
# Unit tests for LemonWayClient::MoneyInInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInInput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInInput.new
  end
  ...
  describe 'test an instance of MoneyInInput' do
    it 'should create an instance of MoneyInInput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInInput)
    end
  end
