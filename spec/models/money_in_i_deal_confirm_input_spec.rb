...
# Unit tests for SwaggerClient::MoneyInIDealConfirmInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInIDealConfirmInput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInIDealConfirmInput.new
  end
  ...
  describe 'test an instance of MoneyInIDealConfirmInput' do
    it 'should create an instance of MoneyInIDealConfirmInput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInIDealConfirmInput)
    end
  end
end
