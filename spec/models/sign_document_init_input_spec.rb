...
# Unit tests for LemonWayClient::SignDocumentInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SignDocumentInitInput' do
  before do
    # run before each test
    @instance = LemonWayClient::SignDocumentInitInput.new
  end
  ...
  describe 'test an instance of SignDocumentInitInput' do
    it 'should create an instance of SignDocumentInitInput' do
      expect(@instance).to be_instance_of(LemonWayClient::SignDocumentInitInput)
    end
  end
