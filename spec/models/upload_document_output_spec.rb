...
# Unit tests for SwaggerClient::UploadDocumentOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UploadDocumentOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::UploadDocumentOutput.new
  end
  ...
  describe 'test an instance of UploadDocumentOutput' do
    it 'should create an instance of UploadDocumentOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::UploadDocumentOutput)
    end
  end
