...
# Unit tests for LemonWayClient::BalanceHistoryOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BalanceHistoryOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::BalanceHistoryOutput.new
  end
  ...
  describe 'test an instance of BalanceHistoryOutput' do
    it 'should create an instance of BalanceHistoryOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::BalanceHistoryOutput)
    end
  end
