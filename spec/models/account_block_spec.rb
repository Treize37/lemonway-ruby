...
# Unit tests for LemonWayClient::AccountBlock
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountBlock' do
  before do
    # run before each test
    @instance = LemonWayClient::AccountBlock.new
  end
  ...
  describe 'test an instance of AccountBlock' do
    it 'should create an instance of AccountBlock' do
      expect(@instance).to be_instance_of(LemonWayClient::AccountBlock)
    end
  end
