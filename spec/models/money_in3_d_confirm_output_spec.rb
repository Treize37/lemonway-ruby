...
# Unit tests for LemonWayClient::MoneyIn3DConfirmOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyIn3DConfirmOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyIn3DConfirmOutput.new
  end
  ...
  describe 'test an instance of MoneyIn3DConfirmOutput' do
    it 'should create an instance of MoneyIn3DConfirmOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyIn3DConfirmOutput)
    end
  end
