...
# Unit tests for LemonWayClient::CreateIBANInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateIBANInput' do
  before do
    # run before each test
    @instance = LemonWayClient::CreateIBANInput.new
  end
  ...
  describe 'test an instance of CreateIBANInput' do
    it 'should create an instance of CreateIBANInput' do
      expect(@instance).to be_instance_of(LemonWayClient::CreateIBANInput)
    end
  end
