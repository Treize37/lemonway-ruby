...
# Unit tests for SwaggerClient::RegisterIndividualAccountOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterIndividualAccountOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::RegisterIndividualAccountOutput.new
  end
  ...
  describe 'test an instance of RegisterIndividualAccountOutput' do
    it 'should create an instance of RegisterIndividualAccountOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::RegisterIndividualAccountOutput)
    end
  end
