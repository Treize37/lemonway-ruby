...
# Unit tests for LemonWayClient::GetCompletedPaymentFormInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCompletedPaymentFormInput' do
  before do
    # run before each test
    @instance = LemonWayClient::GetCompletedPaymentFormInput.new
  end
  ...
  describe 'test an instance of GetCompletedPaymentFormInput' do
    it 'should create an instance of GetCompletedPaymentFormInput' do
      expect(@instance).to be_instance_of(LemonWayClient::GetCompletedPaymentFormInput)
    end
  end
end
