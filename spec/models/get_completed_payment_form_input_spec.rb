...
# Unit tests for SwaggerClient::GetCompletedPaymentFormInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCompletedPaymentFormInput' do
  before do
    # run before each test
    @instance = SwaggerClient::GetCompletedPaymentFormInput.new
  end
  ...
  describe 'test an instance of GetCompletedPaymentFormInput' do
    it 'should create an instance of GetCompletedPaymentFormInput' do
      expect(@instance).to be_instance_of(SwaggerClient::GetCompletedPaymentFormInput)
    end
  end
end
