...
# Unit tests for LemonWayClient::AccountDetailsOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountDetailsOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::AccountDetailsOutput.new
  end
  ...
  describe 'test an instance of AccountDetailsOutput' do
    it 'should create an instance of AccountDetailsOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::AccountDetailsOutput)
    end
  end
