...
# Unit tests for SwaggerClient::AccountDetailsOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountDetailsOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::AccountDetailsOutput.new
  end
  ...
  describe 'test an instance of AccountDetailsOutput' do
    it 'should create an instance of AccountDetailsOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::AccountDetailsOutput)
    end
  end
