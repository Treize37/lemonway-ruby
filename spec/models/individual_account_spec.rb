...
# Unit tests for SwaggerClient::IndividualAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IndividualAccount' do
  before do
    # run before each test
    @instance = SwaggerClient::IndividualAccount.new
  end
  ...
  describe 'test an instance of IndividualAccount' do
    it 'should create an instance of IndividualAccount' do
      expect(@instance).to be_instance_of(SwaggerClient::IndividualAccount)
    end
  end
