...
# Unit tests for SwaggerClient::DisablePaymentFormInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DisablePaymentFormInput' do
  before do
    # run before each test
    @instance = SwaggerClient::DisablePaymentFormInput.new
  end
  ...
  describe 'test an instance of DisablePaymentFormInput' do
    it 'should create an instance of DisablePaymentFormInput' do
      expect(@instance).to be_instance_of(SwaggerClient::DisablePaymentFormInput)
    end
  end
end
