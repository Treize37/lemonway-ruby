...
# Unit tests for LemonWayClient::MoneyInTrustlyInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInTrustlyInitOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInTrustlyInitOutput.new
  end
  ...
  describe 'test an instance of MoneyInTrustlyInitOutput' do
    it 'should create an instance of MoneyInTrustlyInitOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInTrustlyInitOutput)
    end
  end
