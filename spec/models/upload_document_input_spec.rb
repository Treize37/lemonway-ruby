...
# Unit tests for SwaggerClient::UploadDocumentInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UploadDocumentInput' do
  before do
    # run before each test
    @instance = SwaggerClient::UploadDocumentInput.new
  end
  ...
  describe 'test an instance of UploadDocumentInput' do
    it 'should create an instance of UploadDocumentInput' do
      expect(@instance).to be_instance_of(SwaggerClient::UploadDocumentInput)
    end
  end
