...
# Unit tests for LemonWayClient::UploadDocumentInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UploadDocumentInput' do
  before do
    # run before each test
    @instance = LemonWayClient::UploadDocumentInput.new
  end
  ...
  describe 'test an instance of UploadDocumentInput' do
    it 'should create an instance of UploadDocumentInput' do
      expect(@instance).to be_instance_of(LemonWayClient::UploadDocumentInput)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Integer', ["0", "1", "2", "3", "4", "5", "7", "11", "12", "13", "21"])
