...
# Unit tests for SwaggerClient::RegisterCardOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterCardOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::RegisterCardOutput.new
  end
  ...
  describe 'test an instance of RegisterCardOutput' do
    it 'should create an instance of RegisterCardOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::RegisterCardOutput)
    end
  end
