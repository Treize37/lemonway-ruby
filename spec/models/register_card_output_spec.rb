...
# Unit tests for LemonWayClient::RegisterCardOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterCardOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::RegisterCardOutput.new
  end
  ...
  describe 'test an instance of RegisterCardOutput' do
    it 'should create an instance of RegisterCardOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::RegisterCardOutput)
    end
  end
