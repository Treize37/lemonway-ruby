...
# Unit tests for LemonWayClient::MoneyInWebInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInWebInitOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInWebInitOutput.new
  end
  ...
  describe 'test an instance of MoneyInWebInitOutput' do
    it 'should create an instance of MoneyInWebInitOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInWebInitOutput)
    end
  end
  describe 'test attribute "web_kit_token"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "id_"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
