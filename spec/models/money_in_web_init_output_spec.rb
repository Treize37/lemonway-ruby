...
# Unit tests for SwaggerClient::MoneyInWebInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInWebInitOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInWebInitOutput.new
  end
  ...
  describe 'test an instance of MoneyInWebInitOutput' do
    it 'should create an instance of MoneyInWebInitOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInWebInitOutput)
    end
  end
