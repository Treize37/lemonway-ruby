...
# Unit tests for SwaggerClient::UpdateAccountStatusInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateAccountStatusInput' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateAccountStatusInput.new
  end
  ...
  describe 'test an instance of UpdateAccountStatusInput' do
    it 'should create an instance of UpdateAccountStatusInput' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateAccountStatusInput)
    end
  end
