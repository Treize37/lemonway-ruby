...
# Unit tests for LemonWayClient::RegisterSddMandateOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterSddMandateOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::RegisterSddMandateOutput.new
  end
  ...
  describe 'test an instance of RegisterSddMandateOutput' do
    it 'should create an instance of RegisterSddMandateOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::RegisterSddMandateOutput)
    end
  end
  describe 'test attribute "ssd_mandate"' do
    it 'should work' do
