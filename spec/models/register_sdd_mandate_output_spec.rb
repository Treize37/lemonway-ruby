...
# Unit tests for SwaggerClient::RegisterSddMandateOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterSddMandateOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::RegisterSddMandateOutput.new
  end
  ...
  describe 'test an instance of RegisterSddMandateOutput' do
    it 'should create an instance of RegisterSddMandateOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::RegisterSddMandateOutput)
    end
  end
