...
# Unit tests for SwaggerClient::UpdateAccountStatusOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateAccountStatusOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateAccountStatusOutput.new
  end
  ...
  describe 'test an instance of UpdateAccountStatusOutput' do
    it 'should create an instance of UpdateAccountStatusOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateAccountStatusOutput)
    end
  end
