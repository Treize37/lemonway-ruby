...
# Unit tests for LemonWayClient::PaymentFormDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentFormDetails' do
  before do
    # run before each test
    @instance = LemonWayClient::PaymentFormDetails.new
  end
  ...
  describe 'test an instance of PaymentFormDetails' do
    it 'should create an instance of PaymentFormDetails' do
      expect(@instance).to be_instance_of(LemonWayClient::PaymentFormDetails)
    end
  end
  ...
  describe 'test attribute "parent_comment"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "amount_tot"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
