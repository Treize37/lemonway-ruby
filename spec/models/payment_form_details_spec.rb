...
# Unit tests for SwaggerClient::PaymentFormDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentFormDetails' do
  before do
    # run before each test
    @instance = SwaggerClient::PaymentFormDetails.new
  end
  ...
  describe 'test an instance of PaymentFormDetails' do
    it 'should create an instance of PaymentFormDetails' do
      expect(@instance).to be_instance_of(SwaggerClient::PaymentFormDetails)
    end
  end
