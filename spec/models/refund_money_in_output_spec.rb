...
# Unit tests for SwaggerClient::RefundMoneyInOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RefundMoneyInOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::RefundMoneyInOutput.new
  end
  ...
  describe 'test an instance of RefundMoneyInOutput' do
    it 'should create an instance of RefundMoneyInOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::RefundMoneyInOutput)
    end
  end
