...
# Unit tests for LemonWayClient::MoneyInWithCardIdInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInWithCardIdInput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInWithCardIdInput.new
  end
  ...
  describe 'test an instance of MoneyInWithCardIdInput' do
    it 'should create an instance of MoneyInWithCardIdInput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInWithCardIdInput)
    end
  end
  ...
  describe 'test attribute "delayed_days"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "special_config"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
