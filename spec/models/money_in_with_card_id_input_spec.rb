...
# Unit tests for SwaggerClient::MoneyInWithCardIdInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInWithCardIdInput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInWithCardIdInput.new
  end
  ...
  describe 'test an instance of MoneyInWithCardIdInput' do
    it 'should create an instance of MoneyInWithCardIdInput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInWithCardIdInput)
    end
  end
