...
# Unit tests for LemonWayClient::UnregisterIBANInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UnregisterIBANInput' do
  before do
    # run before each test
    @instance = LemonWayClient::UnregisterIBANInput.new
  end
  ...
  describe 'test an instance of UnregisterIBANInput' do
    it 'should create an instance of UnregisterIBANInput' do
      expect(@instance).to be_instance_of(LemonWayClient::UnregisterIBANInput)
    end
  end
