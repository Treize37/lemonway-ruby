...
# Unit tests for SwaggerClient::MoneyInSddInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInSddInitOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInSddInitOutput.new
  end
  ...
  describe 'test an instance of MoneyInSddInitOutput' do
    it 'should create an instance of MoneyInSddInitOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInSddInitOutput)
    end
  end
