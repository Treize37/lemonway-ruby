...
# Unit tests for LemonWayClient::CancelMoneyInInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CancelMoneyInInput' do
  before do
    # run before each test
    @instance = LemonWayClient::CancelMoneyInInput.new
  end
  ...
  describe 'test an instance of CancelMoneyInInput' do
    it 'should create an instance of CancelMoneyInInput' do
      expect(@instance).to be_instance_of(LemonWayClient::CancelMoneyInInput)
    end
  end
