...
# Unit tests for LemonWayClient::UpdateIndividualAccountDetailsOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateIndividualAccountDetailsOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::UpdateIndividualAccountDetailsOutput.new
  end
  ...
  describe 'test an instance of UpdateIndividualAccountDetailsOutput' do
    it 'should create an instance of UpdateIndividualAccountDetailsOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::UpdateIndividualAccountDetailsOutput)
    end
  end
