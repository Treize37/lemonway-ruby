...
# Unit tests for LemonWayClient::MoneyInOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInOutput.new
  end
  ...
  describe 'test an instance of MoneyInOutput' do
    it 'should create an instance of MoneyInOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInOutput)
    end
  end
