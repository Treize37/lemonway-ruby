...
# Unit tests for SwaggerClient::UnregisterIBANOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UnregisterIBANOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::UnregisterIBANOutput.new
  end
  ...
  describe 'test an instance of UnregisterIBANOutput' do
    it 'should create an instance of UnregisterIBANOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::UnregisterIBANOutput)
    end
  end
