...
# Unit tests for LemonWayClient::UnregisterIBANOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UnregisterIBANOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::UnregisterIBANOutput.new
  end
  ...
  describe 'test an instance of UnregisterIBANOutput' do
    it 'should create an instance of UnregisterIBANOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::UnregisterIBANOutput)
    end
  end
