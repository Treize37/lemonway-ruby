...
# Unit tests for SwaggerClient::MoneyInValidateOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInValidateOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInValidateOutput.new
  end
  ...
  describe 'test an instance of MoneyInValidateOutput' do
    it 'should create an instance of MoneyInValidateOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInValidateOutput)
    end
  end
