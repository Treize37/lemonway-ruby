...
# Unit tests for SwaggerClient::MoneyInPayshopInitOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInPayshopInitOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInPayshopInitOutput.new
  end
  ...
  describe 'test an instance of MoneyInPayshopInitOutput' do
    it 'should create an instance of MoneyInPayshopInitOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInPayshopInitOutput)
    end
  end
