...
# Unit tests for SwaggerClient::GetMoneyOutTransDetailsOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMoneyOutTransDetailsOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::GetMoneyOutTransDetailsOutput.new
  end
  ...
  describe 'test an instance of GetMoneyOutTransDetailsOutput' do
    it 'should create an instance of GetMoneyOutTransDetailsOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::GetMoneyOutTransDetailsOutput)
    end
  end
