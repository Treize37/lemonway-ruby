...
# Unit tests for LemonWayClient::AccountDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountDetails' do
  before do
    # run before each test
    @instance = LemonWayClient::AccountDetails.new
  end
  ...
  describe 'test an instance of AccountDetails' do
    it 'should create an instance of AccountDetails' do
      expect(@instance).to be_instance_of(LemonWayClient::AccountDetails)
    end
  end
  ...
  describe 'test attribute "client_title"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
