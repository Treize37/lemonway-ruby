...
# Unit tests for SwaggerClient::DisableIBANOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DisableIBANOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::DisableIBANOutput.new
  end
  ...
  describe 'test an instance of DisableIBANOutput' do
    it 'should create an instance of DisableIBANOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::DisableIBANOutput)
    end
  end
