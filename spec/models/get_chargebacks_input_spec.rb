...
# Unit tests for SwaggerClient::GetChargebacksInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetChargebacksInput' do
  before do
    # run before each test
    @instance = SwaggerClient::GetChargebacksInput.new
  end
  ...
  describe 'test an instance of GetChargebacksInput' do
    it 'should create an instance of GetChargebacksInput' do
      expect(@instance).to be_instance_of(SwaggerClient::GetChargebacksInput)
    end
  end
