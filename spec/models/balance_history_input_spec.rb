...
# Unit tests for LemonWayClient::BalanceHistoryInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BalanceHistoryInput' do
  before do
    # run before each test
    @instance = LemonWayClient::BalanceHistoryInput.new
  end
  ...
  describe 'test an instance of BalanceHistoryInput' do
    it 'should create an instance of BalanceHistoryInput' do
      expect(@instance).to be_instance_of(LemonWayClient::BalanceHistoryInput)
    end
  end
