...
# Unit tests for LemonWayClient::RegisterIBANOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegisterIBANOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::RegisterIBANOutput.new
  end
  ...
  describe 'test an instance of RegisterIBANOutput' do
    it 'should create an instance of RegisterIBANOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::RegisterIBANOutput)
    end
  end
