...
# Unit tests for SwaggerClient::TransactionsTransactionOut
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionsTransactionOut' do
  before do
    # run before each test
    @instance = SwaggerClient::TransactionsTransactionOut.new
  end
  ...
  describe 'test an instance of TransactionsTransactionOut' do
    it 'should create an instance of TransactionsTransactionOut' do
      expect(@instance).to be_instance_of(SwaggerClient::TransactionsTransactionOut)
    end
  end
