...
# Unit tests for SwaggerClient::AccountMandatsOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountMandatsOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::AccountMandatsOutput.new
  end
  ...
  describe 'test an instance of AccountMandatsOutput' do
    it 'should create an instance of AccountMandatsOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::AccountMandatsOutput)
    end
  end
