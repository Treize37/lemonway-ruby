...
# Unit tests for LemonWayClient::MoneyInPayTrailInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInPayTrailInitInput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInPayTrailInitInput.new
  end
  ...
  describe 'test an instance of MoneyInPayTrailInitInput' do
    it 'should create an instance of MoneyInPayTrailInitInput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInPayTrailInitInput)
    end
  end
