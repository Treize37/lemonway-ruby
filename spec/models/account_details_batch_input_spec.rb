...
# Unit tests for SwaggerClient::AccountDetailsBatchInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountDetailsBatchInput' do
  before do
    # run before each test
    @instance = SwaggerClient::AccountDetailsBatchInput.new
  end
  ...
  describe 'test an instance of AccountDetailsBatchInput' do
    it 'should create an instance of AccountDetailsBatchInput' do
      expect(@instance).to be_instance_of(SwaggerClient::AccountDetailsBatchInput)
    end
  end
