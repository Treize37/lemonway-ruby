...
# Unit tests for SwaggerClient::MoneyInMbwayInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInMbwayInitInput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInMbwayInitInput.new
  end
  ...
  describe 'test an instance of MoneyInMbwayInitInput' do
    it 'should create an instance of MoneyInMbwayInitInput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInMbwayInitInput)
    end
  end
