...
# Unit tests for LemonWayClient::TransactionP2P
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionP2P' do
  before do
    # run before each test
    @instance = LemonWayClient::TransactionP2P.new
  end
  ...
  describe 'test an instance of TransactionP2P' do
    it 'should create an instance of TransactionP2P' do
      expect(@instance).to be_instance_of(LemonWayClient::TransactionP2P)
    end
  end
  ...
  describe 'test attribute "private_data"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "fee_reference"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
