...
# Unit tests for SwaggerClient::AccountBalancesInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountBalancesInput' do
  before do
    # run before each test
    @instance = SwaggerClient::AccountBalancesInput.new
  end
  ...
  describe 'test an instance of AccountBalancesInput' do
    it 'should create an instance of AccountBalancesInput' do
      expect(@instance).to be_instance_of(SwaggerClient::AccountBalancesInput)
    end
  end
