...
# Unit tests for LemonWayClient::AccountBalancesInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountBalancesInput' do
  before do
    # run before each test
    @instance = LemonWayClient::AccountBalancesInput.new
  end
  ...
  describe 'test an instance of AccountBalancesInput' do
    it 'should create an instance of AccountBalancesInput' do
      expect(@instance).to be_instance_of(LemonWayClient::AccountBalancesInput)
    end
  end
  ...
  describe 'test attribute "internal_account_id_start"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "internal_account_id_end"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
