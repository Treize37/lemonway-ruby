...
# Unit tests for SwaggerClient::MoneyInIDealConfirmOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInIDealConfirmOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInIDealConfirmOutput.new
  end
  ...
  describe 'test an instance of MoneyInIDealConfirmOutput' do
    it 'should create an instance of MoneyInIDealConfirmOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInIDealConfirmOutput)
    end
  end
