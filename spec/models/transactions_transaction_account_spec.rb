...
# Unit tests for LemonWayClient::TransactionsTransactionAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionsTransactionAccount' do
  before do
    # run before each test
    @instance = LemonWayClient::TransactionsTransactionAccount.new
  end
  ...
  describe 'test an instance of TransactionsTransactionAccount' do
    it 'should create an instance of TransactionsTransactionAccount' do
      expect(@instance).to be_instance_of(LemonWayClient::TransactionsTransactionAccount)
    end
  end
