...
# Unit tests for LemonWayClient::CreateIBANOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateIBANOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::CreateIBANOutput.new
  end
  ...
  describe 'test an instance of CreateIBANOutput' do
    it 'should create an instance of CreateIBANOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::CreateIBANOutput)
    end
  end
  ...
  describe 'test attribute "max_available_iban_per_wallet"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "max_available_iban"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
