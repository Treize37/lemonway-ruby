...
# Unit tests for SwaggerClient::CreateIBANOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateIBANOutput' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateIBANOutput.new
  end
  ...
  describe 'test an instance of CreateIBANOutput' do
    it 'should create an instance of CreateIBANOutput' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateIBANOutput)
    end
  end
