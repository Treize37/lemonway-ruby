...
# Unit tests for LemonWayClient::GetMoneyInIBANDetailsOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMoneyInIBANDetailsOutput' do
  before do
    # run before each test
    @instance = LemonWayClient::GetMoneyInIBANDetailsOutput.new
  end
  ...
  describe 'test an instance of GetMoneyInIBANDetailsOutput' do
    it 'should create an instance of GetMoneyInIBANDetailsOutput' do
      expect(@instance).to be_instance_of(LemonWayClient::GetMoneyInIBANDetailsOutput)
    end
  end
