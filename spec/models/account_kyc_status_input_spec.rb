...
# Unit tests for LemonWayClient::AccountKycStatusInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountKycStatusInput' do
  before do
    # run before each test
    @instance = LemonWayClient::AccountKycStatusInput.new
  end
  ...
  describe 'test an instance of AccountKycStatusInput' do
    it 'should create an instance of AccountKycStatusInput' do
      expect(@instance).to be_instance_of(LemonWayClient::AccountKycStatusInput)
    end
  end
