...
# Unit tests for SwaggerClient::MoneyInTrustlyInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInTrustlyInitInput' do
  before do
    # run before each test
    @instance = SwaggerClient::MoneyInTrustlyInitInput.new
  end
  ...
  describe 'test an instance of MoneyInTrustlyInitInput' do
    it 'should create an instance of MoneyInTrustlyInitInput' do
      expect(@instance).to be_instance_of(SwaggerClient::MoneyInTrustlyInitInput)
    end
  end
