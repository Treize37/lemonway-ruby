...
# Unit tests for LemonWayClient::MoneyInTrustlyInitInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyInTrustlyInitInput' do
  before do
    # run before each test
    @instance = LemonWayClient::MoneyInTrustlyInitInput.new
  end
  ...
  describe 'test an instance of MoneyInTrustlyInitInput' do
    it 'should create an instance of MoneyInTrustlyInitInput' do
      expect(@instance).to be_instance_of(LemonWayClient::MoneyInTrustlyInitInput)
    end
  end
  describe 'test attribute "final_customer_email"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "final_customer_first_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "final_customer_last_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
