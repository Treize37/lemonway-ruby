...
# Unit tests for LemonWayClient::PrivateData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PrivateData' do
  before do
    # run before each test
    @instance = LemonWayClient::PrivateData.new
  end
  ...
  describe 'test an instance of PrivateData' do
    it 'should create an instance of PrivateData' do
      expect(@instance).to be_instance_of(LemonWayClient::PrivateData)
    end
  end
