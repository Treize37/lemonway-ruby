...
# Unit tests for LemonWayClient::DisputesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DisputesApi' do
  before do
    # run before each test
    @instance = LemonWayClient::DisputesApi.new
  end
  ...
  describe 'test an instance of DisputesApi' do
    it 'should create an instance of DisputesApi' do
      expect(@instance).to be_instance_of(LemonWayClient::DisputesApi)
    end
  end

  # unit tests for disputes_disputes_get
  ...
  describe 'disputes_disputes_get test' do
    it 'should work' do
