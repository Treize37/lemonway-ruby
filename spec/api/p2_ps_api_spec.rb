...
# Unit tests for LemonWayClient::P2PsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'P2PsApi' do
  before do
    # run before each test
    @instance = LemonWayClient::P2PsApi.new
  end
  ...
  describe 'test an instance of P2PsApi' do
    it 'should create an instance of P2PsApi' do
      expect(@instance).to be_instance_of(LemonWayClient::P2PsApi)
    end
  end

  # unit tests for p2_ps_p2p_get
  ...
  describe 'p2_ps_p2p_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for p2_ps_p2p_post
  ...
  describe 'p2_ps_p2p_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
