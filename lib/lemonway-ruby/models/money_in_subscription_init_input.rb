...
module LemonWayClient
  class MoneyInSubscriptionInitInput
    # Subscription ID.
    ...
    def list_invalid_properties
      ...
      if @subscription_id.to_s.length > 24
        invalid_properties.push('invalid value for "subscription_id", the character length must be smaller than or equal to 24.')
      end

      if @subscription_id.to_s.length < 0
        invalid_properties.push('invalid value for "subscription_id", the character length must be great than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if @subscription_id.to_s.length > 24
      return false if @subscription_id.to_s.length < 0
    ...
    def subscription_id=(subscription_id)
      if subscription_id.nil?
        fail ArgumentError, 'subscription_id cannot be nil'
      end

      if subscription_id.to_s.length > 24
        fail ArgumentError, 'invalid value for "subscription_id", the character length must be smaller than or equal to 24.'
      end

      if subscription_id.to_s.length < 0
        fail ArgumentError, 'invalid value for "subscription_id", the character length must be great than or equal to 0.'
      end
    ...
    def hash
      [subscription_id, count, account_id, total_amount, commission_amount, comment, auto_commission].hash
    end
