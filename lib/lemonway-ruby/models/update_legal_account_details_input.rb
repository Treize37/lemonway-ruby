...
module LemonWayClient
  class UpdateLegalAccountDetailsInput
    ...
    def hash
      [company, email, title, first_name, last_name, adresse, birth, phone_number, mobile_number, is_debtor, nationality, payer_or_beneficiary].hash
    end
