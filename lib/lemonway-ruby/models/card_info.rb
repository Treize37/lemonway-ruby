...
module LemonWayClient
  class CardInfo
    # Card Type.  0 = CB.  1 = Visa.  2 = Mastercard.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cardCode')
        self.card_code = attributes[:'cardCode']
      end

      if attributes.has_key?(:'cardDate')
        self.card_date = attributes[:'cardDate']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @card_number.to_s.length > 19
        invalid_properties.push('invalid value for "card_number", the character length must be smaller than or equal to 19.')
      end

      if @card_number.to_s.length < 13
        invalid_properties.push('invalid value for "card_number", the character length must be great than or equal to 13.')
      end

      if @card_code.nil?
        invalid_properties.push('invalid value for "card_code", card_code cannot be nil.')
      end

      if @card_code.to_s.length > 3
        invalid_properties.push('invalid value for "card_code", the character length must be smaller than or equal to 3.')
      end

      if @card_code.to_s.length < 3
        invalid_properties.push('invalid value for "card_code", the character length must be great than or equal to 3.')
      end

      if @card_date.nil?
        invalid_properties.push('invalid value for "card_date", card_date cannot be nil.')
      end

      if @card_date !~ Regexp.new(/^(0[1-9]|1[0-2])\/([12]\\d{3})$/)
        invalid_properties.push('invalid value for "card_date", must conform to the pattern /^(0[1-9]|1[0-2])\/([12]\\d{3})$/.')
      end
    ...
    def valid?
      ...
      card_type_validator = EnumAttributeValidator.new('Integer', ['0', '1', '2'])
      return false unless card_type_validator.valid?(@card_type)
      return false if @card_number.nil?
      return false if @card_number.to_s.length > 19
      return false if @card_number.to_s.length < 13
      return false if @card_code.nil?
      return false if @card_code.to_s.length > 3
      return false if @card_code.to_s.length < 3
      return false if @card_date.nil?
      return false if @card_date !~ Regexp.new(/^(0[1-9]|1[0-2])\/([12]\\d{3})$/)
      true
    end
    ...
    def card_number=(card_number)
      ...
      if card_number.to_s.length > 19
        fail ArgumentError, 'invalid value for "card_number", the character length must be smaller than or equal to 19.'
      end

      if card_number.to_s.length < 13
        fail ArgumentError, 'invalid value for "card_number", the character length must be great than or equal to 13.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] card_code Value to be assigned
    def card_code=(card_code)
      if card_code.nil?
        fail ArgumentError, 'card_code cannot be nil'
      end

      if card_code.to_s.length > 3
        fail ArgumentError, 'invalid value for "card_code", the character length must be smaller than or equal to 3.'
      end

      if card_code.to_s.length < 3
        fail ArgumentError, 'invalid value for "card_code", the character length must be great than or equal to 3.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] card_date Value to be assigned
    def card_date=(card_date)
      if card_date.nil?
        fail ArgumentError, 'card_date cannot be nil'
      end

      if card_date !~ Regexp.new(/^(0[1-9]|1[0-2])\/([12]\\d{3})$/)
        fail ArgumentError, 'invalid value for "card_date", must conform to the pattern /^(0[1-9]|1[0-2])\/([12]\\d{3})$/.'
      end
    ...
    def hash
      [card_type, card_number, card_code, card_date].hash
    end
