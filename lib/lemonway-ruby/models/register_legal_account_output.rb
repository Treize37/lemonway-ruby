...
module LemonWayClient
  class RegisterLegalAccountOutput
    attr_accessor :legal_account
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'legalAccount')
        self.legal_account = attributes[:'legalAccount']
      end
