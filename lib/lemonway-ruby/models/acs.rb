...
module LemonWayClient
  class ACS
    ...
    attr_accessor :pareq_field_name

    attr_accessor :pareq_field_value

    attr_accessor :termurl_field_name

    attr_accessor :md_field_name

    attr_accessor :md_field_value

    attr_accessor :mpi_result
    ...
    def self.attribute_map
      {
        ...
        :'pareq_field_name' => :'pareqFieldName',
        :'pareq_field_value' => :'pareqFieldValue',
        :'termurl_field_name' => :'termurlFieldName',
        :'md_field_name' => :'mdFieldName',
        :'md_field_value' => :'mdFieldValue',
    ...
    def self.swagger_types
      {
        ...
        :'pareq_field_name' => :'String',
        :'pareq_field_value' => :'String',
        :'termurl_field_name' => :'String',
        :'md_field_name' => :'String',
        :'md_field_value' => :'String',
        :'mpi_result' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'actionMethod')
        self.action_method = attributes[:'actionMethod']
      end

      if attributes.has_key?(:'pareqFieldName')
        self.pareq_field_name = attributes[:'pareqFieldName']
      end

      if attributes.has_key?(:'pareqFieldValue')
        self.pareq_field_value = attributes[:'pareqFieldValue']
      end

      if attributes.has_key?(:'termurlFieldName')
        self.termurl_field_name = attributes[:'termurlFieldName']
      end

      if attributes.has_key?(:'mdFieldName')
        self.md_field_name = attributes[:'mdFieldName']
      end

      if attributes.has_key?(:'mdFieldValue')
        self.md_field_value = attributes[:'mdFieldValue']
      end

      if attributes.has_key?(:'mpiResult')
        self.mpi_result = attributes[:'mpiResult']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          action_method == o.action_method &&
          pareq_field_name == o.pareq_field_name &&
          pareq_field_value == o.pareq_field_value &&
          termurl_field_name == o.termurl_field_name &&
          md_field_name == o.md_field_name &&
          md_field_value == o.md_field_value &&
          mpi_result == o.mpi_result
    end
    ...
    def hash
      [action_url, action_method, pareq_field_name, pareq_field_value, termurl_field_name, md_field_name, md_field_value, mpi_result].hash
    end
