...
module LemonWayClient
  class MoneyInWebInitOutput
    # Payment Token to pass to WEBKIT url using GET
    attr_accessor :web_kit_token
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'webKitToken')
    ...
    def hash
      [web_kit_token, id_, card_id, error].hash
    end
