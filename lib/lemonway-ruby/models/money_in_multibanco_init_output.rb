...
module LemonWayClient
  class MoneyInMultibancoInitOutput
    attr_accessor :eu_pago_init
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'euPagoInit')
        self.eu_pago_init = attributes[:'euPagoInit']
      end
