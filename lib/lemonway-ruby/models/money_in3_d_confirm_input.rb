...
module LemonWayClient
  class MoneyIn3DConfirmInput
    ...
    # MD Data returned by 3D Secure site.
    attr_accessor :md

    # Pares Data returned by 3DS authentication web site.
    attr_accessor :pares
    ...
    def hash
      [is_pre_auth, delayed_days, card, md, pares, special_config].hash
    end
