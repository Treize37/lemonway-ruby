...
module LemonWayClient
  class MoneyOutInput
    ...
    # This should be set to No (0) for most White Label.  If true:  1. [amountCom] will be ignored and will be replaced with Lemon Way's fee.  2. The white label will not receive any fee.
    ...
    def list_invalid_properties
      ...
      if @auto_commission.nil?
        invalid_properties.push('invalid value for "auto_commission", auto_commission cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @auto_commission.nil?
      true
    end
    ...
    def hash
      [account_id, iban_id, total_amount, commission_amount, comment, auto_commission].hash
    end
