...
module LemonWayClient
  class MoneyIn3DInitInput
    # Card informations.
    attr_accessor :card

    # URL of return of the 3D Secure web site. Your CLIENT will be redirected on this URL, which should be your WHITE BRAND web site URL.
    ...
    def hash
      [card, return_url, reference, account_id, total_amount, commission_amount, comment, auto_commission].hash
    end
