  ...
  class Address
    ...
    def list_invalid_properties
      ...
      if !@city.nil? && @city.to_s.length > 140
        invalid_properties.push('invalid value for "city", the character length must be smaller than or equal to 140.')
      end
    ...
    def city=(city)
      if !city.nil? && city.to_s.length > 140
        fail ArgumentError, 'invalid value for "city", the character length must be smaller than or equal to 140.'
      end
    ...
    def hash
      [street, post_code, city, country].hash
    end
