...
module LemonWayClient
  class TransactionOut
    ...
    # ID of the money-in that caused the chargeback
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'originId')
        self.origin_id = attributes[:'originId']
      end
    ...
    def hash
      [sender_account_id, debit_amount, iban_id, masked_label, bank_status, psp, origin_id, id, date, commission_amount, comment, status, lemon_way_commission].hash
    end
