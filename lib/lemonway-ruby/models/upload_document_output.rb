...
module LemonWayClient
  class UploadDocumentOutput
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'uploadDocument')
        self.upload_document = attributes[:'uploadDocument']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          upload_document == o.upload_document &&
          error == o.error
    end
