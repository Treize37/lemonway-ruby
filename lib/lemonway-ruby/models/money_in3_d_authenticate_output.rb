...
module LemonWayClient
  class MoneyIn3DAuthenticateOutput
    # ATOS return code:  00: authenticated owner  55: owner not authenticated  62: Owner By-pass on ACS
    attr_accessor :operation3_d_code
    ...
    def self.attribute_map
      {
        :'operation3_d_code' => :'Operation3DCode',
        :'error' => :'error'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Operation3DCode')
        self.operation3_d_code = attributes[:'Operation3DCode']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          operation3_d_code == o.operation3_d_code &&
          error == o.error
    end
