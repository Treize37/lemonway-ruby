...
module LemonWayClient
  class AccountBalancesInput
    # Date in UTC Seconds.  Leave empty if you wish to use payment account IDs instead.
    attr_accessor :update_date

    # First payment account internal ID, starting from 12.
    attr_accessor :internal_account_id_start

    # Last payment account internal ID, starting from 12.
    attr_accessor :internal_account_id_end

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'update_date' => :'updateDate',
        :'internal_account_id_start' => :'internalAccountIdStart',
        :'internal_account_id_end' => :'internalAccountIdEnd'
      }
    end
    ...
    def self.swagger_types
      {
        :'update_date' => :'String',
        :'internal_account_id_start' => :'Integer',
        :'internal_account_id_end' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'internalAccountIdStart')
        self.internal_account_id_start = attributes[:'internalAccountIdStart']
      end

      if attributes.has_key?(:'internalAccountIdEnd')
        self.internal_account_id_end = attributes[:'internalAccountIdEnd']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@update_date.nil? && @update_date !~ Regexp.new(/^-?\\d{1,12}$/)
        invalid_properties.push('invalid value for "update_date", must conform to the pattern /^-?\\d{1,12}$/.')
      end
    ...
    def valid?
      return false if !@update_date.nil? && @update_date !~ Regexp.new(/^-?\\d{1,12}$/)
      true
    end
    ...
    def update_date=(update_date)
      if !update_date.nil? && update_date !~ Regexp.new(/^-?\\d{1,12}$/)
        fail ArgumentError, 'invalid value for "update_date", must conform to the pattern /^-?\\d{1,12}$/.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          internal_account_id_start == o.internal_account_id_start &&
          internal_account_id_end == o.internal_account_id_end
    end
    ...
    def hash
      [update_date, internal_account_id_start, internal_account_id_end].hash
    end
