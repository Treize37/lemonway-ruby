...
module LemonWayClient
  class LegalAccount
    # Updated Wallet ID (your choice when you did create the Wallet).
    attr_accessor :id

    # Lemon Way Wallet ID (you cannot choose this number). This number is also printed in our BACKOFFICE.
    attr_accessor :lemonway_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lemonwayId')
        self.lemonway_id = attributes[:'lemonwayId']
      end
