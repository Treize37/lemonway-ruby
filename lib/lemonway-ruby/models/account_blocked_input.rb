  ...
  class AccountBlockedInput
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isBlocked')
        self.is_blocked = attributes[:'isBlocked']
      end
    ...
    def list_invalid_properties
      ...
      if @is_blocked.nil?
        invalid_properties.push('invalid value for "is_blocked", is_blocked cannot be nil.')
      end
    ...
    def valid?
      return false if @is_blocked.nil?
