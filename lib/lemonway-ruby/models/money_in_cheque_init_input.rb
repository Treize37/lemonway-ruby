...
module LemonWayClient
  class MoneyInChequeInitInput
    ...
    # Cheque payment (by default) or Pagaré.  15 = Cheque payment.  23 = Pagaré.
    attr_accessor :cheque_type
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'chequeType')
        self.cheque_type = attributes[:'chequeType']
      end
    ...
    def list_invalid_properties
      ...
      if !@transfer_id.nil? && @transfer_id.to_s.length > 8
        invalid_properties.push('invalid value for "transfer_id", the character length must be smaller than or equal to 8.')
      end

      if !@transfer_id.nil? && @transfer_id.to_s.length < 0
        invalid_properties.push('invalid value for "transfer_id", the character length must be great than or equal to 0.')
      end

      if !@partner.nil? && @partner.to_s.length > 256
        invalid_properties.push('invalid value for "partner", the character length must be smaller than or equal to 256.')
      end

      if !@partner.nil? && @partner.to_s.length < 0
        invalid_properties.push('invalid value for "partner", the character length must be great than or equal to 0.')
      end
    ...
    def valid?
      return false if !@transfer_id.nil? && @transfer_id.to_s.length > 8
      return false if !@transfer_id.nil? && @transfer_id.to_s.length < 0
      return false if !@partner.nil? && @partner.to_s.length > 256
      return false if !@partner.nil? && @partner.to_s.length < 0
      cheque_type_validator = EnumAttributeValidator.new('Integer', ['15', '23'])
      return false unless cheque_type_validator.valid?(@cheque_type)
    ...
    # @param [Object] transfer_id Value to be assigned
    def transfer_id=(transfer_id)
      if !transfer_id.nil? && transfer_id.to_s.length > 8
        fail ArgumentError, 'invalid value for "transfer_id", the character length must be smaller than or equal to 8.'
      end

      if !transfer_id.nil? && transfer_id.to_s.length < 0
        fail ArgumentError, 'invalid value for "transfer_id", the character length must be great than or equal to 0.'
      end
    ...
    def partner=(partner)
      if !partner.nil? && partner.to_s.length > 256
        fail ArgumentError, 'invalid value for "partner", the character length must be smaller than or equal to 256.'
      end

      if !partner.nil? && partner.to_s.length < 0
        fail ArgumentError, 'invalid value for "partner", the character length must be great than or equal to 0.'
      end
    ...
    # @param [Object] cheque_type Object to be assigned
    def cheque_type=(cheque_type)
      validator = EnumAttributeValidator.new('Integer', ['15', '23'])
      unless validator.valid?(cheque_type)
        fail ArgumentError, 'invalid value for "cheque_type", must be one of #{validator.allowable_values}.'
      end
    ...
    def hash
      [transfer_id, partner, cheque_type, account_id, total_amount, commission_amount, comment, auto_commission].hash
    end
