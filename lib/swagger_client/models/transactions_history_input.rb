...
module SwaggerClient
  class TransactionsHistoryInput
    # UTC Unix timestamp.  In order to return transactions initialized after startDate.  If the payment account is \"SC\" then this value is mandatory.
    attr_accessor :start_date

    # UTC Unix timestamp.  In order to return transactions initialized before endDate.  If the payment account is \"SC\" then this value is mandatory and the time span cannot exceed 1 week.
