...
module SwaggerClient
  class SignDocumentInitOutput
    # Payment token to use as GET parameter when redirecting your user to the WEBKIT.  Note: the token can be used as long as the mandate is not successfully signed,   so even if the user comes back to your error page (if the user cancelled for example),   you can still submit the same token to the WEBKIT.
    attr_accessor :sign_document
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'signDocument')
        self.sign_document = attributes[:'signDocument']
      end
