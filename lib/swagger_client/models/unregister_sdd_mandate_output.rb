...
module SwaggerClient
  class UnregisterSddMandateOutput
    attr_accessor :sdd_mandate
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SDDMandate')
        self.sdd_mandate = attributes[:'SDDMandate']
      end
