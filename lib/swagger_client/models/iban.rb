...
module SwaggerClient
  class Iban
    ...
    # Only status 5 allows the use of the IBAN for a money-out.  The list of types is available in annex.
    ...
    # Indicates it it's a merchant iban or a virtual client iban.  1: merchant iban  2: iban virtual client.
    attr_accessor :type
    ...
    def hash
      [id, status, iban, swift, holder, type].hash
    end
