...
module SwaggerClient
  class Document
    ...
    # Status of the document.  The list of status is available  in annex.
    attr_accessor :status

    # Type of document.  The list of types is available in annex.
    attr_accessor :type

    # Validity date of the document  Format: dd/mm/yyyy  Empty if unknown
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'validityDate')
        self.validity_date = attributes[:'validityDate']
      end
    ...
    def hash
      [id, status, type, validity_date, comment].hash
    end
