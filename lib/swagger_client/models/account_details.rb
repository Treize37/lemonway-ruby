...
module SwaggerClient
  class AccountDetails
    ...
    # Internal ID given by LEMON WAY (ID displayed on the BACKOFFICE)
    ...
    # Indicates if wallet is blocked or not:  0: not blocked  1: blocked
    ...
    # For crowdfunding/loan platforms, indicates if the wallet is created for a debtor   0 or empty: no  1: yes
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'internalId')
        self.internal_id = attributes[:'internalId']
      end

      if attributes.has_key?(:'clientTitle')
        self.client_title = attributes[:'clientTitle']
      end
      ...
      if attributes.has_key?(:'isblocked')
    ...
    def hash
      [id, internal_id, client_title, firstname, lastname, balance, email, status, isblocked, account_type, company, adresse, birth, nationality, phone_number, mobile_number, is_debtor, payer_or_beneficiary].hash
    end
