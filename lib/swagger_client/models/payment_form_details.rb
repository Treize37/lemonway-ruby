...
module SwaggerClient
  class PaymentFormDetails
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'parentComment')
        self.parent_comment = attributes[:'parentComment']
      end

      if attributes.has_key?(:'amountTot')
        self.amount_tot = attributes[:'amountTot']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          parent_comment == o.parent_comment &&
          amount_tot == o.amount_tot &&
          status == o.status &&
          utc_date == o.utc_date &&
          created == o.created &&
          id == o.id &&
    ...
    def hash
      [parent_id, parent_comment, amount_tot, status, utc_date, created, id, opt_id, account_payer, account_receiver, comment, return_url, cancel_url, error_url, first_name_payer, last_name_payer, email_payer].hash
    end
