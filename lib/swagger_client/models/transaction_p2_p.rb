...
module SwaggerClient
  class TransactionP2P
    ...
    # Debited amount  Amounts are given as integer numbers in cents.
    ...
    # returned 1 for P2P commission transaction
    attr_accessor :is_fee

    # original transaction id
    attr_accessor :fee_reference
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isFee')
        self.is_fee = attributes[:'isFee']
      end

      if attributes.has_key?(:'feeReference')
        self.fee_reference = attributes[:'feeReference']
      end
    ...
    def hash
      [sender_account_id, receiver_account_id, debit_amount, credit_amount, private_data, scheduled_date, is_fee, fee_reference, id, date, commission_amount, comment, status, lemon_way_commission].hash
    end
