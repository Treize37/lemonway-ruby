...
module SwaggerClient
  class Card
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'is3DS')
        self.is3_ds = attributes[:'is3DS']
      end
      ...
      if attributes.has_key?(:'authorizationNumber')
        self.authorization_number = attributes[:'authorizationNumber']
      end

      if attributes.has_key?(:'maskedNumber')
        self.masked_number = attributes[:'maskedNumber']
      end
    ...
    def hash
      [id, is3_ds, country, authorization_number, masked_number, expiration, type].hash
    end
