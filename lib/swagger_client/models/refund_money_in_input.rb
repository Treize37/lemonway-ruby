...
module SwaggerClient
  class RefundMoneyInInput
    # Amount to refund. If empty, the total amount of the payment will be refunded.
    attr_accessor :amount_to_refund

    # Comment regarding the refund.  **Please explain why you refund.**
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'amountToRefund')
        self.amount_to_refund = attributes[:'amountToRefund']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          amount_to_refund == o.amount_to_refund &&
          comment == o.comment
    end
