...
module SwaggerClient
  class RegisterSddMandateOutput
    attr_accessor :ssd_mandate
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SSDMandate')
        self.ssd_mandate = attributes[:'SSDMandate']
      end
