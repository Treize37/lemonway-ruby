...
module SwaggerClient
  class MoneyInMbwayInitInput
    # Phone numbers of the final client.
    attr_accessor :phone
    ...
    def hash
      [phone, return_url, reference, account_id, total_amount, commission_amount, comment, auto_commission].hash
    end
