...
module SwaggerClient
  class RegisterCardInput
    ...
    # Leave empty.
    attr_accessor :special_configuration
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'specialConfiguration')
        self.special_configuration = attributes[:'specialConfiguration']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          card == o.card &&
          special_configuration == o.special_configuration
    end
    ...
    def hash
      [account_id, card, special_configuration].hash
    end
