...
module SwaggerClient
  class UploadDocumentInput
    ...
    # Type of document.  0 = ID Card.  1 = Proof of address.  2 = Scan of a proof of IBAN.  3 = Passport (European Union).  4 = Passport (outside the European Union).  5 = Residence permit.  7 = Official company registration document (Kbis extract or equivalent).  11 = Driver licence.  12 = Status.  13 = Selfie.  21 = SDD mandat.
    attr_accessor :type

    # Byte array with the document. Encode in base 64 if necessary.
    attr_accessor :buffer

    # This allows you to upload mandate document you signed yourself (with your own signing partner) in order to validate a mandate ID you previously created with RegisterSddMandate.
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('Integer', ['0', '1', '2', '3', '4', '5', '7', '11', '12', '13', '21'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('Integer', ['0', '1', '2', '3', '4', '5', '7', '11', '12', '13', '21'])
    ...
    def hash
      [name, type, buffer, sdd_mandate_id].hash
    end
