...
module SwaggerClient
  class UnregisterSddMandateInput
    # Payment account ID.
    ...
    def list_invalid_properties
      ...
      if @account.to_s.length > 256
        invalid_properties.push('invalid value for "account", the character length must be smaller than or equal to 256.')
      end

      if @account.to_s.length < 0
        invalid_properties.push('invalid value for "account", the character length must be great than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if @account.to_s.length > 256
      return false if @account.to_s.length < 0
      true
    end
    ...
    def account=(account)
      ...
      if account.to_s.length > 256
        fail ArgumentError, 'invalid value for "account", the character length must be smaller than or equal to 256.'
      end

      if account.to_s.length < 0
        fail ArgumentError, 'invalid value for "account", the character length must be great than or equal to 0.'
      end
