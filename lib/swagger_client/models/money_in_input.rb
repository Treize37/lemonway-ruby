...
module SwaggerClient
  class MoneyInInput
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isPreAuth')
        self.is_pre_auth = attributes[:'isPreAuth']
      end

      if attributes.has_key?(:'delayedDays')
        self.delayed_days = attributes[:'delayedDays']
      end

      if attributes.has_key?(:'specialConfig')
        self.special_config = attributes[:'specialConfig']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          special_config == o.special_config &&
    ...
    def hash
      [card, is_pre_auth, delayed_days, special_config, reference, account_id, total_amount, commission_amount, comment, auto_commission].hash
    end
