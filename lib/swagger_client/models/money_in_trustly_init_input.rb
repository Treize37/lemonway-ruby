...
module SwaggerClient
  class MoneyInTrustlyInitInput
    # End user email.
    attr_accessor :final_customer_email

    # End user first name.
    attr_accessor :final_customer_first_name

    # End user last name.
    attr_accessor :final_customer_last_name

    # WHITE BRAND return URL, called to terminate the operation and on which the callback will be sent, with data in POST parameters.  This url must contain a unique ID so you know which operation is related to the return.
    ...
    def self.attribute_map
      {
        :'final_customer_email' => :'finalCustomerEmail',
        :'final_customer_first_name' => :'finalCustomerFirstName',
        :'final_customer_last_name' => :'finalCustomerLastName',
    ...
    def self.swagger_types
      {
        :'final_customer_email' => :'String',
        :'final_customer_first_name' => :'String',
        :'final_customer_last_name' => :'String',
        :'return_url' => :'String',
        :'reference' => :'String',
        :'account_id' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'finalCustomerEmail')
        self.final_customer_email = attributes[:'finalCustomerEmail']
      end

      if attributes.has_key?(:'finalCustomerFirstName')
        self.final_customer_first_name = attributes[:'finalCustomerFirstName']
      end

      if attributes.has_key?(:'finalCustomerLastName')
        self.final_customer_last_name = attributes[:'finalCustomerLastName']
      end
    ...
    def list_invalid_properties
      ...
      if @final_customer_last_name.nil?
        invalid_properties.push('invalid value for "final_customer_last_name", final_customer_last_name cannot be nil.')
      end
    ...
    # @param [Object] final_customer_email Value to be assigned
    def final_customer_email=(final_customer_email)
      if final_customer_email.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          final_customer_email == o.final_customer_email &&
          final_customer_first_name == o.final_customer_first_name &&
          final_customer_last_name == o.final_customer_last_name &&
    ...
    def hash
      [final_customer_email, final_customer_first_name, final_customer_last_name, return_url, reference, account_id, total_amount, commission_amount, comment, auto_commission].hash
    end
